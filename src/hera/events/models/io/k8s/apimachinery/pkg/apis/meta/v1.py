    ...
    self_link: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                " Read-only.\n\nDEPRECATED Kubernetes will stop propagating this field"
                " in 1.20 release and the field is planned to be removed in 1.21"
                " release."
            ),
        ),
    ] = None
    ...
    field: Annotated[
        ...
        Field(
            description=(
                ...
                " attributes. Arrays are zero-indexed.  Fields may appear more than"
                " once in an array of causes due to fields having multiple errors."
