...
class PluginArtifact(APIBaseModel):
    configuration: Annotated[
        str | None,
        Field(description=("Configuration is the plugin defined configuration for the artifact driver plugin")),
    ] = None
    connection_timeout_seconds: Annotated[
        int | None,
        Field(
            alias="connectionTimeoutSeconds",
            description=(
                "ConnectionTimeoutSeconds is the timeout for the artifact driver"
                " connection, overriding the driver's timeout"
            ),
        ),
    ] = None
    key: Annotated[
        str,
        Field(description=("Key is the path in the artifact repository where the artifact resides")),
    ]
    name: Annotated[str | None, Field(description="Name is the name of the artifact driver plugin")] = None
...
class PluginArtifactRepository(APIBaseModel):
    configuration: str
    key_format: Annotated[str | None, Field(alias="keyFormat")] = None
    name: str
    ...
    value: Annotated[
        ...
        Field(
            description=(
                ...
                " metric MaxLength is an artificial limit to limit CEL validation costs"
...
class Link(APIBaseModel):
    ...
    target: Annotated[
        ...
        Field(
            description=(
                "Target attribute specifies where a linked document will be opened when"
                ' a user clicks on a link. E.g. "_blank", "_self". If the target is'
                " _blank, it will open in a new tab."
            )
        ),
    ]
    url: Annotated[
...
class ArtifactRepository(APIBaseModel):
    ...
    plugin: Annotated[
        PluginArtifactRepository | None,
        Field(description=("Plugin stores artifact in a plugin-specific artifact repository")),
    ] = None
    s3: Annotated[
...
class Artifact(APIBaseModel):
    ...
    mode: Annotated[
        ...
        Field(
            description=(
                ...
                " when loading input artifacts. It is recommended to set the mode value"
                " to ensure the artifact has the expected permissions in your"
                " container."
            )
        ),
    ] = None
    ...
    plugin: Annotated[
        PluginArtifact | None,
        Field(description="Plugin contains plugin artifact location details"),
    ] = None
    raw: Annotated[
        RawArtifact | None,
...
class Inputs(APIBaseModel):
    ...
    parameters: Annotated[
        ...
        Field(
            description=(
                "Parameters are a list of parameters passed as inputs MaxItems is an"
                " artificial limit to limit CEL validation costs - see note at top of"
                " file"
            )
        ),
    ] = None
...
class Metrics(APIBaseModel):
    prometheus: Annotated[
        ...
        Field(
            description=(
                "Prometheus is a list of prometheus metrics to be emitted MaxItems is"
                " an artificial limit to limit CEL validation costs - see note at top"
                " of file"
            )
        ),
    ] = None
...
class NodeStatus(APIBaseModel):
    ...
    failed_pod_restarts: Annotated[
        int | None,
        Field(
            alias="failedPodRestarts",
            description=(
                "FailedPodRestarts tracks the number of times the pod for this node was"
                " restarted due to infrastructure failures before the main container"
                " started."
            ),
        ),
    ] = None
    ...
    restarting_pod_uid: Annotated[
        str | None,
        Field(
            alias="restartingPodUID",
            description=(
                "RestartingPodUID tracks the UID of the pod that is currently being"
                " restarted. This prevents duplicate restart attempts when the"
                " controller processes the same failed pod multiple times. Cleared when"
                " the replacement pod starts running."
            ),
        ),
    ] = None
...
class DAGTemplate(APIBaseModel):
    ...
    tasks: Annotated[
        ...
        Field(
            description=(
                "Tasks are a list of DAG tasks MaxItems is an artificial limit to limit"
                " CEL validation costs - see note at top of file"
            )
        ),
    ]
...
class Template(APIBaseModel):
    ...
    metadata: Annotated[
        Metadata | None,
        Field(description="Metadata sets the pods's metadata, i.e. annotations and labels"),
    ] = None
    metrics: Annotated[
        Metrics | None,
...
class WorkflowSpec(APIBaseModel):
    ...
    templates: Annotated[
        ...
        Field(
            description=(
                "Templates is a list of workflow templates used in a workflow MaxItems"
                " is an artificial limit to limit CEL validation costs - see note at"
                " top of file"
            )
        ),
    ] = None
