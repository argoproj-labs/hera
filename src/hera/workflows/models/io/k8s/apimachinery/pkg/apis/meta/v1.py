...
class CreateOptions(BaseModel):
    dry_run: Optional[List[str]] = Field(
        ...
        title=(
            ...
            " invalid or unrecognized dryRun directive will\nresult in an error"
    ...
    field_manager: Optional[str] = Field(
        ...
        title=(
            ...
            " these changes. The value must be less than or\n128 characters long, and"
    ...
    field_validation: Optional[str] = Field(
        ...
        title=(
            ...
            " enabled. Valid values are:\n- Ignore: This will ignore any unknown fields"
            " that are silently\ndropped from the object, and will ignore all but the"
            " last duplicate\nfield that the decoder encounters. This is the default"
            " behavior\nprior to v1.23 and is the default behavior when"
            " the\n`ServerSideFieldValidation` feature gate is disabled.\n- Warn: This"
            " will send a warning via the standard warning response\nheader for each"
            " unknown field that is dropped from the object, and\nfor each duplicate"
            " field that is encountered. The request will\nstill succeed if there are"
            " no other errors, and will only persist\nthe last of any duplicate fields."
            " This is the default when the\n`ServerSideFieldValidation` feature gate is"
            " enabled.\n- Strict: This will fail the request with a BadRequest error"
            " if\nany unknown fields would be dropped from the object, or if"
...
class ListMeta(BaseModel):
    ...
    self_link: Optional[str] = Field(
        ...
        description=(
            ...
            " 1.20 release and the field is planned to be removed in 1.21 release."
        ),
    )
...
class ObjectMeta(BaseModel):
    ...
    generate_name: Optional[str] = Field(
        ...
        description=(
            ...
            " (optionally after the time indicated in the Retry-After"
