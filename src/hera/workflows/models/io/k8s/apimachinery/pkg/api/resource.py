...
class Quantity(BaseModel):
    __root__: str = Field(
        ...
        description=(
            ...
            " will be omitted unless the number is negative.\n\nExamples:\n  1.5 will"
            ...
            " these numbers without writing some sort of special handling code in the"
            " hopes that that will cause implementors to also use a fixed point"
            " implementation."
        ),
    )
