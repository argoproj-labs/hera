...
import hera.workflows.v5.examples as hera_examples
import hera.workflows.v5.examples.upstream as hera_upstream_examples
...
def test_hera_output(module_name):
    # GIVEN
    workflow = importlib.import_module(f'hera.workflows.v5.examples.{module_name}').w
...
def test_hera_output_upstream(module_name):
    # GIVEN
    workflow = importlib.import_module(f'hera.workflows.v5.examples.upstream.{module_name}').w
