...
class ArtGCStatus(ArgoBaseModel):
    ...
    pods_recouped: Annotated[
        ...
        Field(
            alias='podsRecouped',
            description=(
                'have completed Pods been processed? (mapped by Pod name) used to prevent re-processing the Status of'
                ' a Pod more than once'
            ),
        ),
    ] = None
    strategies_processed: Annotated[
        ...
        Field(
            ...
            description=(
                "have Pods been started to perform this strategy? (enables us not to re-process what we've already"
                " done)"
            ),
        ),
    ] = None
...
class ArtifactRepositoryRef(ArgoBaseModel):
    config_map: Annotated[
        Optional[str],
        Field(alias='configMap', description='The name of the config map. Defaults to "artifact-repositories".'),
    ] = None
    key: Annotated[
        Optional[str],
        Field(
...
class ArtifactResult(ArgoBaseModel):
    error: Annotated[
        Optional[str], Field(description='Error is an optional error message which should be set if Success==false')
    ] = None
    name: Annotated[str, Field(description='Name is the name of the Artifact')]
    success: Annotated[Optional[bool], Field(description='Success describes whether the deletion succeeded')] = None


class ArtifactResultNodeStatus(ArgoBaseModel):
    artifact_results: Annotated[
        Optional[Dict[str, ArtifactResult]],
        Field(alias='artifactResults', description='ArtifactResults maps Artifact name to result of the deletion'),
    ] = None
...
class CreateS3BucketOptions(ArgoBaseModel):
    object_locking: Annotated[
        Optional[bool], Field(alias='objectLocking', description='ObjectLocking Enable object locking')
    ] = None
...
class Histogram(ArgoBaseModel):
    buckets: Annotated[List[Amount], Field(description='Buckets is a list of bucket divisors for the histogram')]
    value: Annotated[str, Field(description='Value is the value of the metric')]
...
class Item(ArgoBaseModel):
    __root__: Annotated[
        ...
        Field(
            description=(
                'Item expands a single workflow step into multiple parallel steps The value of Item can be a map,'
...
class Link(ArgoBaseModel):
    name: Annotated[str, Field(description='The name of the link, E.g. "Workflow Logs" or "Pod Logs"')]
    scope: Annotated[
        str, Field(description='"workflow", "pod", "pod-logs", "event-source-logs", "sensor-logs" or "chat"')
    ]
    url: Annotated[
        str,
        Field(
...
class MemoizationStatus(ArgoBaseModel):
    cache_name: Annotated[str, Field(alias='cacheName', description='Cache is the name of the cache that was used')]
    hit: Annotated[bool, Field(description='Hit indicates whether this node was created from a cache entry')]
...
class MutexHolding(ArgoBaseModel):
    ...
    mutex: Annotated[
        Optional[str], Field(description='Reference for the mutex e.g: ${namespace}/mutex/${mutexName}')
    ] = None
...
class NodeSynchronizationStatus(ArgoBaseModel):
    waiting: Annotated[
        Optional[str], Field(description='Waiting is the name of the lock that this node is waiting for')
    ] = None
...
class OAuth2EndpointParam(ArgoBaseModel):
    ...
    value: Annotated[Optional[str], Field(description='Value is the literal value to use for the header')] = None
...
class Prometheus(ArgoBaseModel):
    ...
    labels: Annotated[Optional[List[MetricLabel]], Field(description='Labels is a list of metric labels')] = None
    name: Annotated[str, Field(description='Name is the name of the metric')]
    when: Annotated[
        Optional[str], Field(description='When is a conditional statement that decides when to emit the metric')
    ] = None
...
class SuspendTemplate(ArgoBaseModel):
    duration: Annotated[
        ...
        Field(
            description=(
                'Duration is the seconds to wait before automatically resuming a template. Must be a string. Default'
                ' unit is seconds. Could also be a Duration, e.g.: "2m", "6h", "1d"'
            )
        ),
    ] = None
...
class SynchronizationStatus(ArgoBaseModel):
    mutex: Annotated[
        Optional[MutexStatus], Field(description="Mutex stores this workflow's mutex holder details")
    ] = None
    semaphore: Annotated[
        Optional[SemaphoreStatus], Field(description="Semaphore stores this workflow's Semaphore holder details")
    ] = None
...
class TemplateRef(ArgoBaseModel):
    ...
    template: Annotated[
        Optional[str], Field(description='Template is the name of referred template in the resource.')
    ] = None
...
class WorkflowTemplateRef(ArgoBaseModel):
    ...
    name: Annotated[Optional[str], Field(description='Name is the resource name of the workflow template.')] = None
...
class ArtifactGC(ArgoBaseModel):
    pod_metadata: Annotated[
        ...
        Field(
            alias='podMetadata',
            description=(
                'PodMetadata is an optional field for specifying the Labels and Annotations that should be assigned to'
    ...
    service_account_name: Annotated[
        ...
        Field(
            alias='serviceAccountName',
            description=(
                'ServiceAccountName is an optional field for specifying the Service Account that should be assigned to'
                ' the Pod doing the deletion'
            ),
        ),
    ] = None
...
class ArtifactGCStatus(ArgoBaseModel):
    artifact_results_by_node: Annotated[
        ...
        Field(alias='artifactResultsByNode', description='ArtifactResultsByNode maps Node name to result'),
    ] = None
...
class ArtifactoryArtifact(ArgoBaseModel):
    password_secret: Annotated[
        ...
        Field(alias='passwordSecret', description='PasswordSecret is the secret selector to the repository password'),
    ] = None
    url: Annotated[str, Field(description='URL of the artifact')]
    username_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='usernameSecret', description='UsernameSecret is the secret selector to the repository username'),
    ] = None
...
class ArtifactoryArtifactRepository(ArgoBaseModel):
    ...
    repo_url: Annotated[
        Optional[str], Field(alias='repoURL', description='RepoURL is the url for artifactory repo.')
    ] = None
    username_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='usernameSecret', description='UsernameSecret is the secret selector to the repository username'),
...
class AzureArtifact(ArgoBaseModel):
    ...
    blob: Annotated[
        str, Field(description='Blob is the blob name (i.e., path) in the container where the artifact resides')
    ]
    container: Annotated[str, Field(description='Container is the container where resources will be stored')]
    endpoint: Annotated[
        str,
        Field(
            description=(
...
class Cache(ArgoBaseModel):
    config_map: Annotated[
        v1.ConfigMapKeySelector, Field(alias='configMap', description='ConfigMap sets a ConfigMap-based cache')
    ]
...
class ContainerSetRetryStrategy(ArgoBaseModel):
    duration: Annotated[
        ...
        Field(
            description=(
                'Duration is the time between each retry, examples values are "300ms", "1s" or "5m". Valid time units'
...
class CronWorkflowStatus(ArgoBaseModel):
    ...
    conditions: Annotated[
        List[Condition], Field(description='Conditions is a list of conditions the CronWorkflow may have')
    ]
...
class GCSArtifact(ArgoBaseModel):
    ...
    key: Annotated[str, Field(description='Key is the path in the bucket where the artifact resides')]
...
class GitArtifact(ArgoBaseModel):
    branch: Annotated[
        Optional[str], Field(description='Branch is the branch to fetch when `SingleBranch` is enabled')
    ] = None
    depth: Annotated[
        Optional[int],
        Field(
    ...
    disable_submodules: Annotated[
        Optional[bool],
        Field(alias='disableSubmodules', description='DisableSubmodules disables submodules during git clone'),
    ] = None
    fetch: Annotated[
        Optional[List[str]],
    ...
    single_branch: Annotated[
        Optional[bool],
        Field(
            alias='singleBranch', description='SingleBranch enables single branch clone, using the `branch` parameter'
        ),
    ] = None
...
class HDFSArtifact(ArgoBaseModel):
    addresses: Annotated[
        Optional[List[str]], Field(description='Addresses is accessible addresses of HDFS name nodes')
    ] = None
    force: Annotated[Optional[bool], Field(description='Force copies a file forcibly even if it exists')] = None
    hdfs_user: Annotated[
        Optional[str],
        Field(
            alias='hdfsUser',
...
class Memoize(ArgoBaseModel):
    ...
    max_age: Annotated[
        ...
        Field(
            alias='maxAge',
            description=(
                'MaxAge is the maximum age (e.g. "180s", "24h") of an entry that is still considered valid. If an'
                ' entry is older than the MaxAge, it will be ignored.'
            ),
        ),
    ]
...
class Metrics(ArgoBaseModel):
    prometheus: Annotated[
        List[Prometheus], Field(description='Prometheus is a list of prometheus metrics to be emitted')
    ]
...
class OSSArtifact(ArgoBaseModel):
    access_key_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(
            alias='accessKeySecret', description="AccessKeySecret is the secret selector to the bucket's access key"
        ),
    ] = None
    bucket: Annotated[Optional[str], Field(description='Bucket is the name of the bucket')] = None
    create_bucket_if_not_present: Annotated[
        ...
        Field(
            ...
            description=(
                "CreateBucketIfNotPresent tells the driver to attempt to create the OSS bucket for output artifacts,"
                " if it doesn't exist"
            ),
        ),
    ] = None
    endpoint: Annotated[Optional[str], Field(description='Endpoint is the hostname of the bucket endpoint')] = None
    key: Annotated[str, Field(description='Key is the path in the bucket where the artifact resides')]
    lifecycle_rule: Annotated[
        Optional[OSSLifecycleRule],
        Field(alias='lifecycleRule', description="LifecycleRule specifies how to manage bucket's lifecycle"),
    ] = None
    secret_key_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(
            alias='secretKeySecret', description="SecretKeySecret is the secret selector to the bucket's secret key"
        ),
    ] = None
...
class RetryStrategy(ArgoBaseModel):
    affinity: Annotated[
        Optional[RetryAffinity], Field(description="Affinity prevents running workflow's step on the same host")
    ] = None
    ...
    expression: Annotated[
        ...
        Field(
            description=(
                'Expression is a condition expression for when a node will be retried. If it evaluates to false, the'
                ' node will not be retried and the retry strategy will be ignored'
            )
        ),
    ] = None
    limit: Annotated[
        ...
        Field(
            description=(
                'Limit is the maximum number of retry attempts when retrying a container. It does not include the'
                ' original container; the maximum number of total attempts will be `limit + 1`.'
            )
        ),
    ] = None
    retry_policy: Annotated[
        Optional[str],
        Field(alias='retryPolicy', description='RetryPolicy is a policy of NodePhase statuses that will be retried'),
    ] = None
    ...
    kms_encryption_context: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context for more'
                ' information'
            ),
        ),
    ] = None
...
class SemaphoreRef(ArgoBaseModel):
    config_map_key_ref: Annotated[
        Optional[v1.ConfigMapKeySelector],
        Field(
            alias='configMapKeyRef', description='ConfigMapKeyRef is configmap selector for Semaphore configuration'
        ),
    ] = None
...
class Sequence(ArgoBaseModel):
    ...
    format: Annotated[
        Optional[str], Field(description='Format is a printf format string to format the value in the sequence')
    ] = None
    start: Annotated[
        Optional[intstr.IntOrString], Field(description='Number at which to start the sequence (default: 0)')
    ] = None
...
class SubmitOpts(ArgoBaseModel):
    ...
    dry_run: Annotated[
        ...
        Field(
            alias='dryRun',
            description=(
                'DryRun validates the workflow on the client-side without creating it. This option is not supported'
                ' in API'
            ),
        ),
    ] = None
    entry_point: Annotated[
        Optional[str], Field(alias='entryPoint', description='Entrypoint overrides spec.entrypoint')
    ] = None
    generate_name: Annotated[
        Optional[str], Field(alias='generateName', description='GenerateName overrides metadata.generateName')
    ] = None
    ...
    owner_reference: Annotated[
        ...
        Field(alias='ownerReference', description='OwnerReference creates a metadata.ownerReference'),
    ] = None
    parameters: Annotated[
        Optional[List[str]], Field(description='Parameters passes input parameters to workflow')
    ] = None
    pod_priority_class_name: Annotated[
        Optional[str], Field(alias='podPriorityClassName', description='Set the podPriorityClassName of the workflow')
    ] = None
    priority: Annotated[
        Optional[int],
        Field(
            description=(
                ...
                ' higher priority workflows are processed first.'
            )
        ),
    ] = None
...
class Synchronization(ArgoBaseModel):
    ...
    semaphore: Annotated[
        Optional[SemaphoreRef], Field(description='Semaphore holds the Semaphore configuration')
    ] = None
...
class ValueFrom(ArgoBaseModel):
    ...
    event: Annotated[
        ...
        Field(
            description=(
                'Selector (https://github.com/antonmedv/expr) that is evaluated against the event to get the value of'
                ' the parameter. E.g. `payload.message`'
            )
        ),
    ] = None
    expression: Annotated[
        Optional[str], Field(description='Expression, if defined, is evaluated to specify the value for the parameter')
    ] = None
    jq_filter: Annotated[
        Optional[str],
        Field(alias='jqFilter', description='JQFilter expression against the resource object in resource templates'),
    ] = None
    json_path: Annotated[
        Optional[str],
        Field(
...
class Parameter(ArgoBaseModel):
    ...
    enum: Annotated[
        Optional[List[str]],
        Field(description='Enum holds a list of string values to choose from, for the actual value of the parameter'),
    ] = None
    ...
    value: Annotated[
        ...
        Field(
            description=(
                'Value is the literal value to use for the parameter. If specified in the context of an input'
                ' parameter, the value takes precedence over any passed values'
            )
        ),
    ] = None
    value_from: Annotated[
        Optional[ValueFrom],
        Field(alias='valueFrom', description="ValueFrom is the source for the output parameter's value"),
    ] = None
...
class PodGC(ArgoBaseModel):
    label_selector: Annotated[
        ...
        Field(
            alias='labelSelector',
            description=(
                'LabelSelector is the label selector to check if the pods match the labels before being added to the'
                ' pod GC queue.'
            ),
        ),
    ] = None
...
class S3Artifact(ArgoBaseModel):
    ...
    create_bucket_if_not_present: Annotated[
        ...
        Field(
            alias='createBucketIfNotPresent',
            description=(
                "CreateBucketIfNotPresent tells the driver to attempt to create the S3 bucket for output artifacts, if"
                " it doesn't exist. Setting Enabled Encryption will apply either SSE-S3 to the bucket if KmsKeyId is"
    ...
    endpoint: Annotated[Optional[str], Field(description='Endpoint is the hostname of the bucket endpoint')] = None
    insecure: Annotated[Optional[bool], Field(description='Insecure will connect to the service with TLS')] = None
    key: Annotated[Optional[str], Field(description='Key is the key in the bucket where the artifact resides')] = None
    region: Annotated[Optional[str], Field(description='Region contains the optional bucket region')] = None
    role_arn: Annotated[
        Optional[str],
        Field(alias='roleARN', description='RoleARN is the Amazon Resource Name (ARN) of the role to assume.'),
    ] = None
    secret_key_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(
...
class ArtifactRepository(ArgoBaseModel):
    archive_logs: Annotated[
        Optional[bool], Field(alias='archiveLogs', description='ArchiveLogs enables log archiving')
    ] = None
    artifactory: Annotated[
        Optional[ArtifactoryArtifactRepository], Field(description='Artifactory stores artifacts to JFrog Artifactory')
    ] = None
    azure: Annotated[
        Optional[AzureArtifactRepository], Field(description='Azure stores artifact in an Azure Storage account')
    ] = None
    gcs: Annotated[
        Optional[GCSArtifactRepository], Field(description='GCS stores artifact in a GCS object store')
    ] = None
    hdfs: Annotated[Optional[HDFSArtifactRepository], Field(description='HDFS stores artifacts in HDFS')] = None
    oss: Annotated[
        Optional[OSSArtifactRepository], Field(description='OSS stores artifact in a OSS-compliant object store')
    ] = None
    s3: Annotated[
        Optional[S3ArtifactRepository], Field(description='S3 stores artifact in a S3-compliant object store')
    ] = None
...
class ArtifactRepositoryRefStatus(ArgoBaseModel):
    ...
    namespace: Annotated[
        ...
        Field(
            description=(
                "The namespace of the config map. Defaults to the workflow's namespace, or the controller's namespace"
                " (if found)."
            )
        ),
    ] = None
...
class HTTP(ArgoBaseModel):
    ...
    body_from: Annotated[
        ...
        Field(alias='bodyFrom', description='BodyFrom is  content of the HTTP Request as Bytes'),
    ] = None
    headers: Annotated[
...
class HTTPArtifact(ArgoBaseModel):
    auth: Annotated[
        Optional[HTTPAuth], Field(description='Auth contains information for client authentication')
    ] = None
    headers: Annotated[
...
class Artifact(ArgoBaseModel):
    ...
    archive_logs: Annotated[
        Optional[bool],
        Field(alias='archiveLogs', description='ArchiveLogs indicates if the container logs should be archived'),
    ] = None
    artifact_gc: Annotated[
        ...
        Field(
            alias='artifactGC',
            description=(
                'ArtifactGC describes the strategy to use when to deleting an artifact from completed or deleted'
                ' workflows'
            ),
        ),
    ] = None
    artifactory: Annotated[
        Optional[ArtifactoryArtifact], Field(description='Artifactory contains artifactory artifact location details')
    ] = None
    azure: Annotated[
        Optional[AzureArtifact], Field(description='Azure contains Azure Storage artifact location details')
    ] = None
    deleted: Annotated[Optional[bool], Field(description='Has this been deleted?')] = None
    from_: Annotated[
        Optional[str],
        Field(alias='from', description='From allows an artifact to reference an artifact from a previous step'),
    ] = None
    ...
    gcs: Annotated[Optional[GCSArtifact], Field(description='GCS contains GCS artifact location details')] = None
    git: Annotated[Optional[GitArtifact], Field(description='Git contains git artifact location details')] = None
    global_name: Annotated[
        Optional[str],
        Field(
            alias='globalName',
    ...
    hdfs: Annotated[Optional[HDFSArtifact], Field(description='HDFS contains HDFS artifact location details')] = None
    http: Annotated[Optional[HTTPArtifact], Field(description='HTTP contains HTTP artifact location details')] = None
    mode: Annotated[
        Optional[int],
        Field(
            description=(
    ...
    name: Annotated[str, Field(description="name of the artifact. must be unique within a template's inputs/outputs.")]
    optional: Annotated[
        Optional[bool], Field(description="Make Artifacts optional, if Artifacts doesn't generate or exist")
    ] = None
    oss: Annotated[Optional[OSSArtifact], Field(description='OSS contains OSS artifact location details')] = None
    path: Annotated[Optional[str], Field(description='Path is the container path to the artifact')] = None
    raw: Annotated[Optional[RawArtifact], Field(description='Raw contains raw artifact location details')] = None
    ...
    s3: Annotated[Optional[S3Artifact], Field(description='S3 contains S3 artifact location details')] = None
    sub_path: Annotated[
        Optional[str],
        Field(
            alias='subPath',
...
class ArtifactNodeSpec(ArgoBaseModel):
    ...
    artifacts: Annotated[
        Optional[Dict[str, Artifact]], Field(description='Artifacts maps artifact name to Artifact description')
    ] = None
...
class Inputs(ArgoBaseModel):
    artifacts: Annotated[
        Optional[List[Artifact]], Field(description='Artifact are a list of artifacts passed as inputs')
    ] = None
    parameters: Annotated[
        Optional[List[Parameter]], Field(description='Parameters are a list of parameters passed as inputs')
    ] = None
...
class Outputs(ArgoBaseModel):
    artifacts: Annotated[
        Optional[List[Artifact]], Field(description='Artifacts holds the list of output artifacts produced by a step')
    ] = None
    exit_code: Annotated[
        Optional[str], Field(alias='exitCode', description='ExitCode holds the exit code of a script template')
    ] = None
    parameters: Annotated[
        Optional[List[Parameter]],
        Field(description='Parameters holds the list of output parameters produced by a step'),
    ] = None
    result: Annotated[Optional[str], Field(description='Result holds the result (stdout) of a script template')] = None
...
class ResourceTemplate(ArgoBaseModel):
    ...
    manifest_from: Annotated[
        ...
        Field(alias='manifestFrom', description='ManifestFrom is the source for a single kubernetes manifest'),
    ] = None
...
class ScriptTemplate(ArgoBaseModel):
    ...
    source: Annotated[str, Field(description='Source contains the source code of the script to execute')]
    startup_probe: Annotated[
        Optional[v1.Probe],
        Field(
            alias='startupProbe',
...
class Data(ArgoBaseModel):
    source: Annotated[DataSource, Field(description='Source sources external data into a data template')]
    transformation: Annotated[
        List[TransformationStep], Field(description='Transformation applies a set of transformations')
    ]


class LifecycleHook(ArgoBaseModel):
    arguments: Annotated[Optional[Arguments], Field(description='Arguments hold arguments to the template')] = None
    expression: Annotated[
        Optional[str],
        Field(
            description=(
    ...
    template: Annotated[
        Optional[str], Field(description='Template is the name of the template to execute by the hook')
    ] = None
...
class NodeStatus(ArgoBaseModel):
    ...
    estimated_duration: Annotated[
        Optional[int], Field(alias='estimatedDuration', description='EstimatedDuration in seconds.')
    ] = None
    finished_at: Annotated[
        Optional[v1_1.Time], Field(alias='finishedAt', description='Time at which this node completed')
    ] = None
    ...
    memoization_status: Annotated[
        ...
        Field(alias='memoizationStatus', description='MemoizationStatus holds information about cached nodes'),
    ] = None
    message: Annotated[
        Optional[str],
        Field(description='A human readable message indicating details about why the node is in this condition.'),
    ] = None
    name: Annotated[str, Field(description='Name is unique name in the node tree used to generate the node ID')]
    outbound_nodes: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' every invocation of a template, there are nodes which we considered as "outbound". Essentially,'
                ' these are last nodes in the execution sequence to run, before the template is considered completed.'
                ' These nodes are then connected as parents to a following step.\n\nIn the case of single pod steps'
                ' (i.e. container, script, resource templates), this list will be nil since the pod itself is already'
                ' considered the "outbound" node. In the case of DAGs, outbound nodes are the "target" tasks (tasks'
                ' with no children). In the case of steps, outbound nodes are all the containers involved in the last'
                ' step group. NOTE: since templates are composable, the list of outbound nodes are carried upwards'
                ' when a DAG/steps template invokes another DAG/steps template. In other words, the outbound nodes of'
    ...
    phase: Annotated[
        ...
        Field(
            description=(
                'Phase a simple, high-level summary of where the node is in its lifecycle. Can be used as a state'
                ' machine.'
            )
        ),
    ] = None
    pod_ip: Annotated[
        Optional[str], Field(alias='podIP', description='PodIP captures the IP of the pod for daemoned steps')
    ] = None
    ...
    resources_duration: Annotated[
        ...
        Field(
            ...
            description=(
                'ResourcesDuration is indicative, but not accurate, resource duration. This is populated when the'
                ' nodes completes.'
            ),
        ),
    ] = None
    started_at: Annotated[
        Optional[v1_1.Time], Field(alias='startedAt', description='Time at which this node started')
    ] = None
    ...
    template_name: Annotated[
        ...
        Field(
            alias='templateName',
            description=(
                'TemplateName is the template name which this node corresponds to. Not applicable to virtual nodes'
                ' (e.g. Retry, StepGroup)'
            ),
        ),
    ] = None
    template_ref: Annotated[
        ...
        Field(
            alias='templateRef',
            description=(
                'TemplateRef is the reference to the template resource which this node corresponds to. Not applicable'
                ' to virtual nodes (e.g. Retry, StepGroup)'
            ),
        ),
    ] = None
...
class Submit(ArgoBaseModel):
    ...
    workflow_template_ref: Annotated[
        WorkflowTemplateRef,
        Field(alias='workflowTemplateRef', description='WorkflowTemplateRef the workflow template to submit'),
    ]
...
class CronWorkflowSpec(ArgoBaseModel):
    ...
    schedule: Annotated[str, Field(description='Schedule is a schedule to run the Workflow in Cron format')]
    ...
    timezone: Annotated[
        ...
        Field(
            description=(
                ...
                ' Default is machine\'s local time.'
            )
        ),
    ] = None
    workflow_metadata: Annotated[
        Optional[v1_1.ObjectMeta],
        Field(
            alias='workflowMetadata', description='WorkflowMetadata contains some metadata of the workflow to be run'
        ),
    ] = None
    workflow_spec: Annotated[
        WorkflowSpec, Field(alias='workflowSpec', description='WorkflowSpec is the spec of the workflow to be run')
    ]


class DAGTask(ArgoBaseModel):
    arguments: Annotated[
        Optional[Arguments], Field(description='Arguments are the parameter and artifact arguments to the template')
    ] = None
    ...
    dependencies: Annotated[
        Optional[List[str]], Field(description='Dependencies are name of other targets which this depends on')
    ] = None
    depends: Annotated[
        Optional[str], Field(description='Depends are name of other targets which this depends on')
    ] = None
    hooks: Annotated[
    ...
    on_exit: Annotated[
        ...
        Field(
            alias='onExit',
            description=(
                'OnExit is a template reference which is invoked at the end of the template, irrespective of the'
                ' success, failure, or error of the primary template. DEPRECATED: Use Hooks[exit].Template instead.'
            ),
        ),
    ] = None
    ...
    template_ref: Annotated[
        Optional[TemplateRef],
        Field(alias='templateRef', description='TemplateRef is the reference to the template resource to execute.'),
    ] = None
    when: Annotated[
        Optional[str], Field(description='When is an expression in which the task should conditionally execute')
    ] = None
    ...
    with_param: Annotated[
        ...
        Field(
            alias='withParam',
            description=(
                'WithParam expands a task into multiple parallel tasks from the value in the parameter, which is'
    ...
    with_sequence: Annotated[
        Optional[Sequence],
        Field(alias='withSequence', description='WithSequence expands a task into a numeric sequence'),
    ] = None
    ...
    fail_fast: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' steps, as soon as it detects that one of the DAG nodes is failed. Then it waits until all DAG nodes'
                ' are completed before failing the DAG itself. The FailFast flag default is true,  if set to false, it'
                ' will allow a DAG to run all branches of the DAG to completion (either success or failure),'
                ' regardless of the failed outcomes of branches in the DAG. More info and example about this feature'
                ' at https://github.com/argoproj/argo-workflows/issues/1442'
            ),
        ),
    ] = None
    target: Annotated[
        Optional[str], Field(description='Target are one or more names of targets to execute in a DAG')
    ] = None
...
class Template(ArgoBaseModel):
    active_deadline_seconds: Annotated[
        ...
        Field(
            ...
            description=(
                'Optional duration in seconds relative to the StartTime that the pod may be active on a node before'
                ' the system actively tries to terminate the pod; value must be positive integer This field is only'
                ' applicable to container and script templates.'
            ),
        ),
    ] = None
    affinity: Annotated[
        ...
        Field(
            description=(
                "Affinity sets the pod's scheduling constraints Overrides the affinity set at the workflow level (if"
                " any)"
            )
        ),
    ] = None
    archive_location: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' overridden by individual items in Outputs. If omitted, will use the default artifact repository'
                ' location configured in the controller, appended with the <workflowname>/<nodename> in the key.'
            ),
        ),
    ] = None
    automount_service_account_token: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' mounted in pods. ServiceAccountName of ExecutorConfig must be specified if this value is false.'
            ),
        ),
    ] = None
    container: Annotated[
        Optional[v1.Container], Field(description='Container is the main container image to run in the pod')
    ] = None
    container_set: Annotated[
        Optional[ContainerSetTemplate],
        Field(alias='containerSet', description='ContainerSet groups multiple containers within a single pod.'),
    ] = None
    daemon: Annotated[
        Optional[bool],
        Field(
    ...
    dag: Annotated[Optional[DAGTemplate], Field(description='DAG template subtype which runs a DAG')] = None
    data: Annotated[Optional[Data], Field(description='Data is a data template')] = None
    executor: Annotated[
        Optional[ExecutorConfig], Field(description='Executor holds configurations of the executor container.')
    ] = None
    fail_fast: Annotated[
        Optional[bool],
        Field(
            alias='failFast',
            description=(
                'FailFast, if specified, will fail this template if any of its child pods has failed. This is useful'
                ' for when this template is expanded with `withItems`, etc.'
            ),
        ),
    ] = None
    ...
    metadata: Annotated[
        Optional[Metadata], Field(description="Metdata sets the pods's metadata, i.e. annotations and labels")
    ] = None
    metrics: Annotated[
        Optional[Metrics], Field(description='Metrics are a list of metrics emitted from this template')
    ] = None
    ...
    parallelism: Annotated[
        ...
        Field(
            description=(
                ...
                ' boundaries of this template invocation. If additional steps/dag templates are invoked, the pods'
                ' created by those templates will not be counted towards this total.'
            )
        ),
    ] = None
    ...
    priority_class_name: Annotated[
        Optional[str], Field(alias='priorityClassName', description='PriorityClassName to apply to workflow pods.')
    ] = None
    resource: Annotated[
        Optional[ResourceTemplate], Field(description='Resource template subtype which can run k8s resources')
    ] = None
    retry_strategy: Annotated[
        Optional[RetryStrategy],
        Field(alias='retryStrategy', description='RetryStrategy describes how to retry a template when it fails'),
    ] = None
    ...
    script: Annotated[
        Optional[ScriptTemplate], Field(description='Script runs a portion of code against an interpreter')
    ] = None
    security_context: Annotated[
    ...
    service_account_name: Annotated[
        Optional[str], Field(alias='serviceAccountName', description='ServiceAccountName to apply to workflow pods')
    ] = None
    sidecars: Annotated[
        Optional[List[UserContainer]],
        Field(
    ...
    steps: Annotated[
        Optional[List[ParallelSteps]], Field(description='Steps define a series of sequential/parallel workflow steps')
    ] = None
    suspend: Annotated[
    ...
    timeout: Annotated[
        ...
        Field(
            description=(
                ...
                " This duration also includes time in which the node spends in Pending state. This duration may not be"
                " applied to Step or DAG templates."
            )
        ),
    ] = None
    tolerations: Annotated[
        Optional[List[v1.Toleration]], Field(description='Tolerations to apply to workflow pods.')
    ] = None
    volumes: Annotated[
...
class WorkflowCreateRequest(ArgoBaseModel):
    ...
    instance_id: Annotated[
        Optional[str], Field(alias='instanceID', description='This field is no longer used.')
    ] = None
    namespace: Optional[str] = None
...
class WorkflowSpec(ArgoBaseModel):
    active_deadline_seconds: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' before the controller terminates the io.argoproj.workflow.v1alpha1. A value of zero is used to'
    ...
    host_network: Annotated[
        Optional[bool],
        Field(alias='hostNetwork', description='Host networking requested for this workflow pod. Default to false.'),
    ] = None
    ...
    metrics: Annotated[
        Optional[Metrics], Field(description='Metrics are a list of metrics emitted from this Workflow')
    ] = None
    node_selector: Annotated[
        Optional[Dict[str, str]],
        Field(
            alias='nodeSelector',
            description=(
                'NodeSelector is a selector which will result in all pods of the workflow to be scheduled on the'
                ' selected node(s). This is able to be overridden by a nodeSelector specified in the template.'
            ),
        ),
    ] = None
    on_exit: Annotated[
        ...
        Field(
            alias='onExit',
            description=(
                'OnExit is a template reference which is invoked at the end of the workflow, irrespective of the'
                ' success, failure, or error of the primary io.argoproj.workflow.v1alpha1.'
            ),
        ),
    ] = None
    parallelism: Annotated[
    ...
    pod_gc: Annotated[
        Optional[PodGC],
        Field(alias='podGC', description='PodGC describes the strategy to use when deleting completed pods'),
    ] = None
    pod_metadata: Annotated[
        Optional[Metadata],
        Field(
    ...
    pod_priority_class_name: Annotated[
        Optional[str], Field(alias='podPriorityClassName', description='PriorityClassName to apply to workflow pods.')
    ] = None
    pod_spec_patch: Annotated[
        Optional[str],
        Field(
    ...
    retry_strategy: Annotated[
        Optional[RetryStrategy],
        Field(
            alias='retryStrategy', description='RetryStrategy for all templates in the io.argoproj.workflow.v1alpha1.'
        ),
    ] = None
    scheduler_name: Annotated[
        Optional[str],
        Field(
            alias='schedulerName',
            description=(
                "Set scheduler name for all pods. Will be overridden if container/script template's scheduler name is"
                " set. Default scheduler will be used if neither specified."
            ),
        ),
    ] = None
    security_context: Annotated[
    ...
    shutdown: Annotated[
        Optional[str], Field(description='Shutdown will shutdown the workflow according to its ShutdownStrategy')
    ] = None
    suspend: Annotated[
        Optional[bool],
        Field(
    ...
    template_defaults: Annotated[
        ...
        Field(
            ...
            description=(
                'TemplateDefaults holds default template values that will apply to all templates in the Workflow,'
                ' unless overridden on the template-level'
            ),
        ),
    ] = None
    templates: Annotated[
        Optional[List[Template]], Field(description='Templates is a list of workflow templates used in a workflow')
    ] = None
    tolerations: Annotated[
        Optional[List[v1.Toleration]], Field(description='Tolerations to apply to workflow pods.')
    ] = None
    ttl_strategy: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' Succeeded or Failed. If this struct is set, once the Workflow finishes, it will be deleted after the'
                ' time to live expires. If this field is unset, the controller config map will hold the default'
                ' values.'
            ),
        ),
    ] = None
    ...
    volume_claim_templates: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' controller will create the claims at the beginning of the workflow and delete the claims upon'
    ...
    workflow_metadata: Annotated[
        ...
        Field(
            alias='workflowMetadata', description='WorkflowMetadata contains some metadata of the workflow to refer to'
        ),
    ] = None
    workflow_template_ref: Annotated[
...
class WorkflowStatus(ArgoBaseModel):
    ...
    artifact_repository_ref: Annotated[
        ...
        Field(
            alias='artifactRepositoryRef',
            description=(
                'ArtifactRepositoryRef is used to cache the repository to use so we do not need to determine it'
                ' everytime we reconcile.'
            ),
        ),
    ] = None
    compressed_nodes: Annotated[
        Optional[str], Field(alias='compressedNodes', description='Compressed and base64 decoded Nodes map')
    ] = None
    conditions: Annotated[
        Optional[List[Condition]], Field(description='Conditions is a list of conditions the Workflow may have')
    ] = None
    estimated_duration: Annotated[
        Optional[int], Field(alias='estimatedDuration', description='EstimatedDuration in seconds.')
    ] = None
    finished_at: Annotated[
        Optional[v1_1.Time], Field(alias='finishedAt', description='Time at which this workflow completed')
    ] = None
    message: Annotated[
        Optional[str],
        Field(description='A human readable message indicating details about why the workflow is in this condition.'),
    ] = None
    nodes: Annotated[
    ...
    offload_node_status_version: Annotated[
        ...
        Field(
            ...
            description=(
                'Whether on not node status has been offloaded to a database. If exists, then Nodes and'
                ' CompressedNodes will be empty. This will actually be populated with a hash of the offloaded data.'
            ),
        ),
    ] = None
    outputs: Annotated[
    ...
    persistent_volume_claims: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' io.argoproj.workflow.v1alpha1. The contents of this list are drained at the end of the workflow.'
            ),
        ),
    ] = None
    phase: Annotated[
    ...
    resources_duration: Annotated[
        Optional[Dict[str, int]],
        Field(alias='resourcesDuration', description='ResourcesDuration is the total for the workflow'),
    ] = None
    started_at: Annotated[
        Optional[v1_1.Time], Field(alias='startedAt', description='Time at which this workflow started')
    ] = None
...
class WorkflowStep(ArgoBaseModel):
    ...
    template: Annotated[
        Optional[str], Field(description='Template is the name of the template to execute as the step')
    ] = None
    template_ref: Annotated[
        Optional[TemplateRef],
        Field(
    ...
    when: Annotated[
        Optional[str], Field(description='When is an expression in which the step should conditionally execute')
    ] = None
    with_items: Annotated[
        Optional[List[Item]],
        Field(
    ...
    with_param: Annotated[
        ...
        Field(
            alias='withParam',
            description=(
                'WithParam expands a step into multiple parallel steps from the value in the parameter, which is'
                ' expected to be a JSON list.'
            ),
        ),
    ] = None
    with_sequence: Annotated[
        Optional[Sequence],
        Field(alias='withSequence', description='WithSequence expands a step into a numeric sequence'),
    ] = None
