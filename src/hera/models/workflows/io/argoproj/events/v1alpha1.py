...
class AMQPConsumeConfig(ArgoBaseModel):
    ...
    no_local: Annotated[
        Optional[bool], Field(alias='noLocal', title='NoLocal flag is not supported by RabbitMQ\n+optional')
    ] = None
    no_wait: Annotated[
        Optional[bool],
        Field(
...
class AMQPExchangeDeclareConfig(ArgoBaseModel):
    auto_delete: Annotated[
        Optional[bool],
        Field(alias='autoDelete', title='AutoDelete removes the exchange when no bindings are active\n+optional'),
    ] = None
    durable: Annotated[
        Optional[bool], Field(title='Durable keeps the exchange also after the server restarts\n+optional')
    ] = None
    internal: Annotated[
        Optional[bool], Field(title='Internal when true does not accept publishings\n+optional')
    ] = None
    no_wait: Annotated[
        Optional[bool],
        Field(alias='noWait', title='NowWait when true does not wait for a confirmation from the server\n+optional'),
    ] = None
...
class AMQPQueueDeclareConfig(ArgoBaseModel):
    ...
    auto_delete: Annotated[
        Optional[bool],
        Field(alias='autoDelete', title='AutoDelete removes the queue when no consumers are active\n+optional'),
    ] = None
    durable: Annotated[
        Optional[bool], Field(title='Durable keeps the queue also after the server restarts\n+optional')
    ] = None
    exclusive: Annotated[
        Optional[bool],
        Field(
            title=(
                'Exclusive sets the queues to be accessible only by the connection that declares them and will'
    ...
    no_wait: Annotated[
        Optional[bool],
        Field(alias='noWait', title='NowWait when true, the queue assumes to be declared on the server\n+optional'),
    ] = None
...
class BitbucketRepository(ArgoBaseModel):
    ...
    repository_slug: Annotated[
        ...
        Field(
            ...
            title=(
                'RepositorySlug is a URL-friendly version of a repository name, automatically generated by Bitbucket'
                ' for use in the URL'
            ),
        ),
    ] = None
...
class BitbucketServerRepository(ArgoBaseModel):
    project_key: Annotated[
        Optional[str],
        Field(alias='projectKey', title='ProjectKey is the key of project for which integration needs to set up'),
    ] = None
    repository_slug: Annotated[
        Optional[str],
        Field(
...
class CatchupConfiguration(ArgoBaseModel):
    enabled: Annotated[
        Optional[bool], Field(title='Enabled enables to triggered the missed schedule when eventsource restarts')
    ] = None
    max_duration: Annotated[
        Optional[str], Field(alias='maxDuration', title='MaxDuration holds max catchup duration')
    ] = None
...
class ConfigMapPersistence(ArgoBaseModel):
    create_if_not_exist: Annotated[
        Optional[bool],
        Field(alias='createIfNotExist', title="CreateIfNotExist will create configmap if it doesn't exists"),
    ] = None
...
class DataFilter(ArgoBaseModel):
    ...
    path: Annotated[
        ...
        Field(
            description=(
                "Path is the JSONPath of the event's (JSON decoded) data key\nPath is a series of keys separated by a"
                " dot. A key may contain wildcard characters '*' and '?'.\nTo access an array value use the index as"
    ...
    template: Annotated[
        ...
        Field(
            title=(
                "Template is a go-template for extracting a string from the event's data.\nA Template is evaluated"
                " with provided path, type and value.\nThe templating follows the standard go-template syntax as well"
                " as sprig's extra functions.\nSee https://pkg.go.dev/text/template and"
...
class EventDependencyTransformer(ArgoBaseModel):
    jq: Annotated[Optional[str], Field(title='JQ holds the jq command applied for transformation\n+optional')] = None
    script: Annotated[
        Optional[str], Field(title='Script refers to a Lua script used to transform the event\n+optional')
    ] = None
    ...
    urls: Annotated[
        ...
        Field(
            description=(
                ...
                ' while push will use all of them.'
            )
        ),
    ] = None
...
class KafkaConsumerGroup(ArgoBaseModel):
    group_name: Annotated[
        Optional[str], Field(alias='groupName', title='The name for the consumer group to use')
    ] = None
    oldest: Annotated[
        Optional[bool],
        Field(
...
class LogTrigger(ArgoBaseModel):
    interval_seconds: Annotated[
        ...
        Field(
            ...
            title=(
                'Only print messages every interval. Useful to prevent logging too much data for busy'
                ' events.\n+optional'
            ),
        ),
    ] = None
...
class PayloadField(ArgoBaseModel):
    name: Annotated[Optional[str], Field(description='Name acts as key that holds the value at the path.')] = None
    path: Annotated[
        Optional[str],
        Field(
            description=(
...
class TriggerParameterSource(ArgoBaseModel):
    context_key: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                " the index as the key. The dot and wildcard characters can be escaped with '\\\\'.\nSee"
                " https://github.com/tidwall/gjson#path-syntax for more information on how to use this."
            ),
        ),
    ] = None
    context_template: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                " ContextTemplate is provided with a ContextKey, the template will be evaluated first and fallback to"
                " the ContextKey.\nThe templating follows the standard go-template syntax as well as sprig's extra"
    ...
    value: Annotated[
        ...
        Field(
            description=(
                'Value is the default literal value to use for this parameter source\nThis is only used if the DataKey'
...
class URLArtifact(ArgoBaseModel):
    ...
    verify_cert: Annotated[
        Optional[bool], Field(alias='verifyCert', title='VerifyCert decides whether the connection is secure or not')
    ] = None
...
class WatchPathConfig(ArgoBaseModel):
    ...
    path: Annotated[
        Optional[str], Field(title='Path is relative path of object to watch with respect to the directory')
    ] = None
...
class AzureEventsHubEventSource(ArgoBaseModel):
    ...
    metadata: Annotated[
        ...
        Field(title='Metadata holds the user defined metadata which will passed along the event payload.\n+optional'),
    ] = None
    shared_access_key: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='sharedAccessKey', title='SharedAccessKey is the generated value of the key'),
    ] = None
...
class Backoff(ArgoBaseModel):
    ...
    factor: Annotated[
        Optional[Amount], Field(title='Duration is multiplied by factor each iteration\n+optional')
    ] = None
    jitter: Annotated[Optional[Amount], Field(title='The amount of jitter applied each iteration\n+optional')] = None
...
class BasicAuth(ArgoBaseModel):
    password: Annotated[
        Optional[v1.SecretKeySelector],
        Field(description='Password refers to the Kubernetes secret that holds the password required for basic auth.'),
    ] = None
    username: Annotated[
        Optional[v1.SecretKeySelector],
        Field(description='Username refers to the Kubernetes secret that holds the username required for basic auth.'),
    ] = None


class BitbucketBasicAuth(ArgoBaseModel):
    password: Annotated[
        Optional[v1.SecretKeySelector], Field(description='Password refers to the K8s secret that holds the password.')
    ] = None
    username: Annotated[
        Optional[v1.SecretKeySelector], Field(description='Username refers to the K8s secret that holds the username.')
    ] = None
...
class CalendarEventSource(ArgoBaseModel):
    ...
    persistence: Annotated[
        Optional[EventPersistence], Field(title='Persistence hold the configuration for event persistence')
    ] = None
    schedule: Annotated[
        Optional[str],
        Field(
...
class Condition(ArgoBaseModel):
    ...
    message: Annotated[
        Optional[str], Field(title='Human-readable message indicating details about last transition.\n+optional')
    ] = None
    reason: Annotated[
        Optional[str],
        Field(
    ...
    status: Annotated[Optional[str], Field(title='Condition status, True, False or Unknown.\n+required')] = None
...
class EventContext(ArgoBaseModel):
    ...
    source: Annotated[Optional[str], Field(description='Source - A URI describing the event producer.')] = None
    ...
    subject: Annotated[
        Optional[str], Field(title='Subject - The subject of the event in the context of the event producer')
    ] = None
    time: Annotated[Optional[v1_1.Time], Field(description='Time - A Timestamp when the event happened.')] = None
    type: Annotated[Optional[str], Field(description='Type - The type of the occurrence which has happened.')] = None


class ExprFilter(ArgoBaseModel):
    expr: Annotated[
        Optional[str], Field(description='Expr refers to the expression that determines the outcome of the filter.')
    ] = None
    fields: Annotated[
...
class FileEventSource(ArgoBaseModel):
    event_type: Annotated[
        ...
        Field(
            alias='eventType',
            title=(
                'Type of file operations to watch\nRefer https://github.com/fsnotify/fsnotify/blob/master/fsnotify.go'
    ...
    watch_path_config: Annotated[
        ...
        Field(alias='watchPathConfig', title='WatchPathConfig contains configuration about the file path to watch'),
    ] = None
...
class GenericEventSource(ArgoBaseModel):
    ...
    url: Annotated[Optional[str], Field(description='URL of the gRPC server that implements the event source.')] = None
...
class GithubAppCreds(ArgoBaseModel):
    app_id: Annotated[
        Optional[str], Field(alias='appID', title='AppID refers to the GitHub App ID for the application you created')
    ] = None
    ...
    private_key: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='privateKey', title='PrivateKey refers to a K8s secret containing the GitHub app private key'),
    ] = None
...
class HDFSEventSource(ArgoBaseModel):
    ...
    check_interval: Annotated[
        ...
        Field(
            alias='checkInterval',
            title=(
                'CheckInterval is a string that describes an interval duration to check the directory state, e.g. 1s,'
                ' 30m, 2h... (defaults to 1m)'
            ),
        ),
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
...
class K8SResourcePolicy(ArgoBaseModel):
    ...
    error_on_backoff_timeout: Annotated[
        ...
        Field(
            ...
            title=(
                'ErrorOnBackoffTimeout determines whether sensor should transition to error state if the trigger'
                ' policy is unable to determine\nthe state of the resource'
            ),
        ),
    ] = None
    labels: Annotated[
        Optional[Dict[str, str]], Field(title='Labels required to identify whether a resource is in success state')
    ] = None


class NATSAuth(ArgoBaseModel):
    basic: Annotated[Optional[BasicAuth], Field(title='Baisc auth with username and password\n+optional')] = None
    credential: Annotated[Optional[v1.SecretKeySelector], Field(title='credential used to connect\n+optional')] = None
...
class PubSubEventSource(ArgoBaseModel):
    ...
    delete_subscription_on_finish: Annotated[
        ...
        Field(
            ...
            title=(
                'DeleteSubscriptionOnFinish determines whether to delete the GCP PubSub subscription once the event'
                ' source is stopped.\n+optional'
            ),
        ),
    ] = None
    ...
    subscription_id: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                ' will be auto generated hash based on this eventsource setting, so the subscription\nmight be'
                ' recreated every time you update the setting, which has a possibility of event loss.\n+optional'
            ),
        ),
    ] = None
    topic: Annotated[
...
class ResourceFilter(ArgoBaseModel):
    ...
    fields: Annotated[
        ...
        Field(
            title=(
                ...
                ' field selector, it supports arbitrary fileds like "spec.serviceAccountName",\nand the value could be'
    ...
    prefix: Annotated[Optional[str], Field(title='Prefix filter is applied on the resource name.\n+optional')] = None
...
class SASLConfig(ArgoBaseModel):
    mechanism: Annotated[
        ...
        Field(
            title=(
                'SASLMechanism is the name of the enabled SASL mechanism.\nPossible values: OAUTHBEARER, PLAIN'
                ' (defaults to PLAIN).\n+optional'
            )
        ),
    ] = None
    password: Annotated[Optional[v1.SecretKeySelector], Field(title='Password for SASL/PLAIN authentication')] = None
    user: Annotated[
        Optional[v1.SecretKeySelector],
        Field(
            title=(
...
class SQSEventSource(ArgoBaseModel):
    ...
    dlq: Annotated[
        ...
        Field(
            title=(
                ...
                " successfully.\nIf set to true, messages with invalid payload won't be acknowledged to allow to"
                " forward them farther to the dead-letter queue.\nThe default value is false.\n+optional"
            )
        ),
    ] = None
    endpoint: Annotated[
        Optional[str],
        Field(title='Endpoint configures connection to a specific SQS endpoint instead of Amazons servers\n+optional'),
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    json_body: Annotated[
        Optional[bool],
    ...
    role_arn: Annotated[
        Optional[str],
        Field(alias='roleARN', title='RoleARN is the Amazon Resource Name (ARN) of the role to assume.\n+optional'),
    ] = None
    secret_key: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='secretKey', title='SecretKey refers K8s secret containing aws secret key'),
    ] = None
...
class TLSConfig(ArgoBaseModel):
    ca_cert_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='caCertSecret', title='CACertSecret refers to the secret that contains the CA cert'),
    ] = None
    client_cert_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='clientCertSecret', title='ClientCertSecret refers to the secret that contains the client cert'),
    ] = None
    client_key_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='clientKeySecret', title='ClientKeySecret refers to the secret that contains the client key'),
    ] = None
    ...
    dest: Annotated[
        ...
        Field(
            description=(
                ...
                " character can be escaped with '.'\nThe -1 key can be used to append a value to an existing"
                " array.\nSee https://github.com/tidwall/sjson#path-syntax for more information about how this is"
                " used."
            )
        ),
    ] = None
...
class TriggerPolicy(ArgoBaseModel):
    k8s: Annotated[
        ...
        Field(
            title=(
                'K8SResourcePolicy refers to the policy used to check the state of K8s based triggers using using'
                ' labels'
            )
        ),
    ] = None
...
class WebhookContext(ArgoBaseModel):
    ...
    max_payload_size: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                ' that limit will be rejected with "request too large" response.\nDefault value: 1048576'
                ' (1MB).\n+optional'
            ),
        ),
    ] = None
    ...
    port: Annotated[
        Optional[str], Field(description='Port on which HTTP server is listening for incoming events.')
    ] = None
    server_cert_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='serverCertSecret', description='ServerCertPath refers the file that contains the cert.'),
    ] = None
    server_key_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='serverKeySecret', title='ServerKeyPath refers the file that contains private key'),
    ] = None
...
class AMQPEventSource(ArgoBaseModel):
    auth: Annotated[
        Optional[BasicAuth], Field(title='Auth hosts secret selectors for username and password\n+optional')
    ] = None
    connection_backoff: Annotated[
        Optional[Backoff],
        Field(alias='connectionBackoff', title='Backoff holds parameters applied to connection.\n+optional'),
    ] = None
    consume: Annotated[
    ...
    exchange_type: Annotated[
        Optional[str], Field(alias='exchangeType', title='ExchangeType is rabbitmq exchange type')
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    json_body: Annotated[
        Optional[bool],
    ...
    queue_bind: Annotated[
        ...
        Field(
            alias='queueBind',
            title=(
                'QueueBind holds the configuration that binds an exchange to a queue so that publishings to'
                ' the\nexchange will be routed to the queue when the publishing routing key matches the binding'
                ' routing key\nFor more information, visit'
    ...
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the amqp client.\n+optional')] = None
    url: Annotated[Optional[str], Field(title='URL for rabbitmq service')] = None
    url_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='urlSecret', title='URLSecret is secret reference for rabbitmq service URL'),
    ] = None
...
class AWSLambdaTrigger(ArgoBaseModel):
    ...
    function_name: Annotated[
        Optional[str],
        Field(alias='functionName', description='FunctionName refers to the name of the function to invoke.'),
    ] = None
    invocation_type: Annotated[
        ...
        Field(
            ...
            description=(
                "Choose from the following options.\n\n   * RequestResponse (default) - Invoke the function"
                " synchronously. Keep\n   the connection open until the function returns a response or times out.\n  "
                " The API response includes the function response and additional data.\n\n   * Event - Invoke the"
                " function asynchronously. Send events that fail multiple\n   times to the function's dead-letter"
                " queue (if it's configured). The API\n   response only includes a status code.\n\n   * DryRun -"
...
class AzureEventHubsTrigger(ArgoBaseModel):
    ...
    hub_name: Annotated[
        Optional[str], Field(alias='hubName', title='HubName refers to the Azure Event Hub to send events to')
    ] = None
    parameters: Annotated[
        Optional[List[TriggerParameter]],
        Field(
    ...
    shared_access_key: Annotated[
        Optional[v1.SecretKeySelector],
        Field(
            alias='sharedAccessKey', title='SharedAccessKey refers to a K8s secret containing the primary key for the'
        ),
    ] = None
    shared_access_key_name: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='sharedAccessKeyName', title='SharedAccessKeyName refers to the name of the Shared Access Key'),
    ] = None


class BitbucketAuth(ArgoBaseModel):
    basic: Annotated[Optional[BitbucketBasicAuth], Field(title='Basic is BasicAuth auth strategy.\n+optional')] = None
...
class BitbucketEventSource(ArgoBaseModel):
    auth: Annotated[
        Optional[BitbucketAuth], Field(description='Auth information required to connect to Bitbucket.')
    ] = None
    ...
    webhook: Annotated[
        Optional[WebhookContext], Field(title='Webhook refers to the configuration required to run an http server')
    ] = None
...
class BitbucketServerEventSource(ArgoBaseModel):
    ...
    delete_hook_on_finish: Annotated[
        ...
        Field(
            alias='deleteHookOnFinish',
            title=(
                'DeleteHookOnFinish determines whether to delete the Bitbucket Server hook for the project once the'
    ...
    webhook: Annotated[
        Optional[WebhookContext], Field(title='Webhook holds configuration to run a http server')
    ] = None
    webhook_secret: Annotated[
        ...
        Field(
            alias='webhookSecret',
            title=(
                'WebhookSecret is reference to K8s secret which holds the bitbucket webhook secret (for HMAC'
                ' validation)'
            ),
        ),
    ] = None
...
class CustomTrigger(ArgoBaseModel):
    ...
    secure: Annotated[
        Optional[bool], Field(title='Secure refers to type of the connection between sensor to custom trigger gRPC')
    ] = None
    ...
    server_url: Annotated[
        Optional[str],
        Field(alias='serverURL', title='ServerURL is the url of the gRPC server that executes custom trigger'),
    ] = None
    spec: Annotated[
        Optional[Dict[str, str]],
        Field(
            description=(
                'Spec is the custom trigger resource specification that custom trigger gRPC server knows how to'
                ' interpret.'
            )
        ),
    ] = None
...
class EmitterEventSource(ArgoBaseModel):
    ...
    channel_key: Annotated[
        Optional[str], Field(alias='channelKey', title='ChannelKey refers to the channel key')
    ] = None
    channel_name: Annotated[
        Optional[str], Field(alias='channelName', title='ChannelName refers to the channel name')
    ] = None
    connection_backoff: Annotated[
        Optional[Backoff],
        Field(alias='connectionBackoff', title='Backoff holds parameters applied to connection.\n+optional'),
    ...
    password: Annotated[
        Optional[v1.SecretKeySelector], Field(title='Password to use to connect to broker\n+optional')
    ] = None
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the emitter client.\n+optional')] = None
    username: Annotated[
        Optional[v1.SecretKeySelector], Field(title='Username to use to connect to broker\n+optional')
    ] = None
...
class EventDependencyFilter(ArgoBaseModel):
    ...
    data: Annotated[Optional[List[DataFilter]], Field(title='Data filter constraints with escalation')] = None
    ...
    expr_logical_operator: Annotated[
        ...
        Field(
            ...
            description=(
                'ExprLogicalOperator defines how multiple Exprs filters (if defined) are evaluated'
...
class GitArtifact(ArgoBaseModel):
    ...
    clone_directory: Annotated[
        ...
        Field(
            ...
            description=(
                "Directory to clone the repository. We clone complete directory because GitArtifact is not limited to"
                " any specific Git service providers.\nHence we don't use any specific git provider client."
            ),
        ),
    ] = None
    creds: Annotated[
        Optional[GitCreds], Field(title='Creds contain reference to git username and password\n+optional')
    ] = None
    file_path: Annotated[
        Optional[str], Field(alias='filePath', title='Path to file that contains trigger resource definition')
    ] = None
    insecure_ignore_host_key: Annotated[
        Optional[bool], Field(alias='insecureIgnoreHostKey', title='Whether to ignore host key\n+optional')
    ] = None
    ref: Annotated[
        Optional[str],
    ...
    ssh_key_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='sshKeySecret', title='SSHKeySecret refers to the secret that contains SSH key'),
    ] = None
...
class GithubEventSource(ArgoBaseModel):
    ...
    api_token: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='apiToken', title='APIToken refers to a K8s secret containing github api token\n+optional'),
    ] = None
    content_type: Annotated[
        Optional[str], Field(alias='contentType', title='ContentType of the event delivery')
    ] = None
    delete_hook_on_finish: Annotated[
        Optional[bool],
        Field(
            alias='deleteHookOnFinish',
            title=(
                'DeleteHookOnFinish determines whether to delete the GitHub hook for the repository once the event'
                ' source is stopped.\n+optional'
            ),
        ),
    ] = None
    events: Annotated[
        Optional[List[str]], Field(title='Events refer to Github events to which the event source will subscribe')
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    github_app: Annotated[
        Optional[GithubAppCreds],
        Field(alias='githubApp', title='GitHubApp holds the GitHub app credentials\n+optional'),
    ] = None
    github_base_url: Annotated[
        Optional[str], Field(alias='githubBaseURL', title='GitHub base URL (for GitHub Enterprise)\n+optional')
    ] = None
    github_upload_url: Annotated[
        Optional[str], Field(alias='githubUploadURL', title='GitHub upload URL (for GitHub Enterprise)\n+optional')
    ] = None
    id: Annotated[
        Optional[str],
        Field(title="Id is the webhook's id\nDeprecated: This is not used at all, will be removed in v1.6\n+optional"),
    ] = None
    ...
    organizations: Annotated[
        ...
        Field(
            description=(
                'Organizations holds the names of organizations (used for organization level webhooks). Not required'
                ' if Repositories is set.'
            )
        ),
    ] = None
    owner: Annotated[
    ...
    repositories: Annotated[
        ...
        Field(
            description=(
                ...
                ' repo names as the value. Not required if Organizations is set.'
            )
        ),
    ] = None
    ...
    webhook: Annotated[
        Optional[WebhookContext], Field(title='Webhook refers to the configuration required to run a http server')
    ] = None
    webhook_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(
...
class GitlabEventSource(ArgoBaseModel):
    ...
    delete_hook_on_finish: Annotated[
        ...
        Field(
            alias='deleteHookOnFinish',
            title=(
                'DeleteHookOnFinish determines whether to delete the GitLab hook for the project once the event source'
                ' is stopped.\n+optional'
            ),
        ),
    ] = None
    enable_ssl_verification: Annotated[
        Optional[bool],
        Field(alias='enableSSLVerification', title='EnableSSLVerification to enable ssl verification\n+optional'),
    ] = None
    events: Annotated[
        Optional[List[str]],
        Field(
    ...
    gitlab_base_url: Annotated[
        Optional[str],
        Field(alias='gitlabBaseURL', title='GitlabBaseURL is the base URL for API requests to a custom endpoint'),
    ] = None
    metadata: Annotated[
        Optional[Dict[str, str]],
        Field(title='Metadata holds the user defined metadata which will passed along the event payload.\n+optional'),
    ...
    project_id: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                ' Projects instead. Will be unsupported in v 1.7\n+optional'
            ),
        ),
    ] = None
    projects: Annotated[
        Optional[List[str]], Field(title='List of project IDs or project namespace paths like "whynowy/test"')
    ] = None
...
class KafkaEventSource(ArgoBaseModel):
    ...
    connection_backoff: Annotated[
        Optional[Backoff],
        Field(alias='connectionBackoff', description='Backoff holds parameters applied to connection.'),
    ] = None
    consumer_group: Annotated[
        Optional[KafkaConsumerGroup], Field(alias='consumerGroup', title='Consumer group for kafka client\n+optional')
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    json_body: Annotated[
        Optional[bool],
    ...
    sasl: Annotated[Optional[SASLConfig], Field(title='SASL configuration for the kafka client\n+optional')] = None
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the kafka client.\n+optional')] = None
    topic: Annotated[Optional[str], Field(title='Topic name')] = None
    url: Annotated[Optional[str], Field(title='URL to kafka cluster, multiple URLs separated by comma')] = None
    version: Annotated[
        Optional[str],
        Field(
            title=(
...
class KafkaTrigger(ArgoBaseModel):
    ...
    sasl: Annotated[Optional[SASLConfig], Field(title='SASL configuration for the kafka client\n+optional')] = None
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the Kafka producer.\n+optional')] = None
    topic: Annotated[
        Optional[str],
        Field(title='Name of the topic.\nMore info at https://kafka.apache.org/documentation/#intro_topics'),
    ] = None
    url: Annotated[
        Optional[str], Field(description='URL of the Kafka broker, multiple URLs separated by comma.')
    ] = None
    version: Annotated[
        Optional[str],
        Field(
...
class MQTTEventSource(ArgoBaseModel):
    ...
    connection_backoff: Annotated[
        Optional[Backoff],
        Field(alias='connectionBackoff', description='ConnectionBackoff holds backoff applied to connection.'),
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    json_body: Annotated[
        Optional[bool],
    ...
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the mqtt client.\n+optional')] = None
    topic: Annotated[Optional[str], Field(title='Topic name')] = None
...
class NATSEventsSource(ArgoBaseModel):
    ...
    subject: Annotated[
        Optional[str], Field(title='Subject holds the name of the subject onto which messages are published')
    ] = None
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the nats client.\n+optional')] = None
...
class NATSTrigger(ArgoBaseModel):
    ...
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the NATS producer.\n+optional')] = None
...
class NSQEventSource(ArgoBaseModel):
    ...
    host_address: Annotated[
        Optional[str], Field(alias='hostAddress', title='HostAddress is the address of the host for NSQ lookup')
    ] = None
    json_body: Annotated[
        Optional[bool],
        Field(
    ...
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the nsq client.\n+optional')] = None
    topic: Annotated[Optional[str], Field(description='Topic to subscribe to.')] = None


class OpenWhiskTrigger(ArgoBaseModel):
    action_name: Annotated[Optional[str], Field(alias='actionName', description='Name of the action/function.')] = None
    auth_token: Annotated[
        Optional[v1.SecretKeySelector], Field(alias='authToken', title='AuthToken for authentication.\n+optional')
    ] = None
    host: Annotated[Optional[str], Field(description='Host URL of the OpenWhisk.')] = None
    namespace: Annotated[
        Optional[str], Field(description='Namespace for the action.\nDefaults to "_".\n+optional.')
    ] = None
    parameters: Annotated[
        Optional[List[TriggerParameter]],
        Field(
...
class PulsarEventSource(ArgoBaseModel):
    ...
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the pulsar client.\n+optional')] = None
    ...
    tls_trust_certs_secret: Annotated[
        Optional[v1.SecretKeySelector],
        Field(alias='tlsTrustCertsSecret', title='Trusted TLS certificate secret.\n+optional'),
    ] = None
    ...
    topics: Annotated[Optional[List[str]], Field(title='Name of the topics to subscribe to.\n+required')] = None
    type: Annotated[
        Optional[str],
        Field(
            title=(
    ...
    url: Annotated[Optional[str], Field(title='Configure the service URL for the Pulsar service.\n+required')] = None
...
class RedisEventSource(ArgoBaseModel):
    ...
    db: Annotated[
        Optional[int], Field(title='DB to use. If not specified, default DB 0 will be used.\n+optional')
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    host_address: Annotated[
        Optional[str], Field(alias='hostAddress', title='HostAddress refers to the address of the Redis host/server')
    ] = None
    json_body: Annotated[
        Optional[bool],
        Field(
    ...
    password: Annotated[
        Optional[v1.SecretKeySelector], Field(title='Password required for authentication if any.\n+optional')
    ] = None
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the redis client.\n+optional')] = None
    username: Annotated[
        Optional[str], Field(title='Username required for ACL style authentication if any.\n+optional')
    ] = None
...
class RedisStreamEventSource(ArgoBaseModel):
    ...
    host_address: Annotated[
        Optional[str],
        Field(
            alias='hostAddress', title='HostAddress refers to the address of the Redis host/server (master instance)'
        ),
    ] = None
    max_msg_count_per_read: Annotated[
        ...
        Field(
            ...
            title=(
                'MaxMsgCountPerRead holds the maximum number of messages per stream that will be read in each'
                ' XREADGROUP of all streams\nExample: if there are 2 streams and MaxMsgCountPerRead=10, then each'
                ' XREADGROUP may read upto a total of 20 messages.\nSame as COUNT option in'
    ...
    filter: Annotated[
        ...
        Field(
            title=(
                ...
                ' informer will only monitor objects that pass the filter.\n+optional'
            )
        ),
    ] = None
    group_version_resource: Annotated[
        Optional[v1_1.GroupVersionResource], Field(alias='groupVersionResource', title='Group of the resource')
    ] = None
    metadata: Annotated[
        Optional[Dict[str, str]],
        Field(title='Metadata holds the user defined metadata which will passed along the event payload.\n+optional'),
...
class SNSEventSource(ArgoBaseModel):
    ...
    endpoint: Annotated[
        Optional[str],
        Field(title='Endpoint configures connection to a specific SNS endpoint instead of Amazons servers\n+optional'),
    ] = None
    filter: Annotated[Optional[EventSourceFilter], Field(title='Filter\n+optional')] = None
    metadata: Annotated[
        Optional[Dict[str, str]],
...
class SecureHeader(ArgoBaseModel):
    ...
    value_from: Annotated[
        ...
        Field(alias='valueFrom', title='Values can be read from either secrets or configmaps'),
    ] = None
...
class Service(ArgoBaseModel):
    cluster_ip: Annotated[
        ...
        Field(
            alias='clusterIP',
            title=(
                'clusterIP is the IP address of the service and is usually assigned\nrandomly by the master. If an'
                ' address is specified manually and is not in\nuse by others, it will be allocated to the service;'
                ' otherwise, creation\nof the service will fail. This field can not be changed through updates.\nValid'
                ' values are "None", empty string (""), or a valid IP address. "None"\ncan be specified for headless'
                ' services when proxying is not required.\nMore info:'
...
class SlackEventSource(ArgoBaseModel):
    ...
    signing_secret: Annotated[
        Optional[v1.SecretKeySelector], Field(alias='signingSecret', title='Slack App signing secret')
    ] = None
    token: Annotated[Optional[v1.SecretKeySelector], Field(title='Token for URL verification handshake')] = None
    webhook: Annotated[Optional[WebhookContext], Field(title='Webhook holds configuration for a REST endpoint')] = None


class SlackTrigger(ArgoBaseModel):
    channel: Annotated[
        Optional[str], Field(title='Channel refers to which Slack channel to send slack message.\n+optional')
    ] = None
    message: Annotated[
        Optional[str], Field(title='Message refers to the message to send to the Slack channel.\n+optional')
    ] = None
    parameters: Annotated[
        Optional[List[TriggerParameter]],
        Field(
...
class StorageGridEventSource(ArgoBaseModel):
    api_url: Annotated[
        Optional[str], Field(alias='apiURL', description='APIURL is the url of the storagegrid api.')
    ] = None
    auth_token: Annotated[
        Optional[v1.SecretKeySelector], Field(alias='authToken', title='Auth token for storagegrid api')
    ] = None
    bucket: Annotated[Optional[str], Field(description='Name of the bucket to register notifications for.')] = None
    events: Optional[List[str]] = None
    filter: Annotated[
        Optional[StorageGridFilter], Field(description='Filter on object key which caused the notification.')
    ] = None
    metadata: Annotated[
        Optional[Dict[str, str]],
        Field(title='Metadata holds the user defined metadata which will passed along the event payload.\n+optional'),
...
class ArtifactLocation(ArgoBaseModel):
    configmap: Annotated[Optional[v1.ConfigMapKeySelector], Field(title='Configmap that stores the artifact')] = None
    file: Annotated[Optional[FileArtifact], Field(title='File artifact is artifact stored in a file')] = None
    git: Annotated[Optional[GitArtifact], Field(title='Git repository hosting the artifact')] = None
    inline: Annotated[Optional[str], Field(title='Inline artifact is embedded in sensor spec as a string')] = None
...
class EventDependency(ArgoBaseModel):
    event_name: Annotated[Optional[str], Field(alias='eventName', title='EventName is the name of the event')] = None
    event_source_name: Annotated[
        Optional[str],
        Field(alias='eventSourceName', title='EventSourceName is the name of EventSource that Sensor depends on'),
    ] = None
    filters: Annotated[
    ...
    transform: Annotated[
        Optional[EventDependencyTransformer], Field(title='Transform transforms the event data')
    ] = None


class HTTPTrigger(ArgoBaseModel):
    basic_auth: Annotated[
        Optional[BasicAuth], Field(alias='basicAuth', title='BasicAuth configuration for the http request.\n+optional')
    ] = None
    headers: Annotated[Optional[Dict[str, str]], Field(title='Headers for the HTTP request.\n+optional')] = None
    method: Annotated[
        Optional[str],
        Field(
            title=(
                'Method refers to the type of the HTTP request.\nRefer https://golang.org/src/net/http/method.go for'
                ' more io.argoproj.workflow.v1alpha1.\nDefault value is POST.\n+optional'
            )
        ),
    ] = None
    parameters: Annotated[
    ...
    timeout: Annotated[
        Optional[str],
        Field(title='Timeout refers to the HTTP request timeout in seconds.\nDefault value is 60 seconds.\n+optional'),
    ] = None
    tls: Annotated[Optional[TLSConfig], Field(title='TLS configuration for the HTTP client.\n+optional')] = None
    url: Annotated[Optional[str], Field(description='URL refers to the URL to send HTTP request to.')] = None
    ...
    live_object: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                ' marshaled from the resource artifact. If set to true, the resource artifact\nmust contain the'
...
class ArgoWorkflowTrigger(ArgoBaseModel):
    args: Annotated[Optional[List[str]], Field(title='Args is the list of arguments to pass to the argo CLI')] = None
    operation: Annotated[
        Optional[str],
        Field(
            title=(
...
class TriggerTemplate(ArgoBaseModel):
    ...
    log: Annotated[
        Optional[LogTrigger],
        Field(title='Log refers to the trigger designed to invoke log the io.argoproj.workflow.v1alpha1.\n+optional'),
    ] = None
    ...
    open_whisk: Annotated[
        ...
        Field(
            alias='openWhisk', title='OpenWhisk refers to the trigger designed to invoke OpenWhisk action.\n+optional'
        ),
    ] = None
    pulsar: Annotated[
...
class Template(ArgoBaseModel):
    affinity: Annotated[
        Optional[v1.Affinity], Field(title="If specified, the pod's scheduling constraints\n+optional")
    ] = None
    container: Annotated[
    ...
    metadata: Annotated[
        Optional[Metadata], Field(title="Metadata sets the pods's metadata, i.e. annotations and labels")
    ] = None
    node_selector: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                " match a node's labels for the pod to be scheduled on that node.\nMore info:"
    ...
    priority_class_name: Annotated[
        ...
        Field(
            ...
            title=(
                ...
                ' former being the highest priority. Any other\nname must be defined by creating a PriorityClass'
    ...
    tolerations: Annotated[
        Optional[List[v1.Toleration]], Field(title="If specified, the pod's tolerations.\n+optional")
    ] = None
    volumes: Annotated[
...
class Trigger(ArgoBaseModel):
    ...
    rate_limit: Annotated[
        Optional[RateLimit], Field(alias='rateLimit', title='Rate limit, default unit is Second\n+optional')
    ] = None
    retry_strategy: Annotated[
        Optional[Backoff], Field(alias='retryStrategy', title='Retry strategy, defaults to no retry\n+optional')
    ] = None
    template: Annotated[
        Optional[TriggerTemplate], Field(description='Template describes the trigger specification.')
    ] = None
...
class EventSourceSpec(ArgoBaseModel):
    ...
    bitbucket: Annotated[Optional[Dict[str, BitbucketEventSource]], Field(title='Bitbucket event sources')] = None
    bitbucketserver: Annotated[
        Optional[Dict[str, BitbucketServerEventSource]], Field(title='Bitbucket Server event sources')
    ] = None
    ...
    event_bus_name: Annotated[
        Optional[str],
        Field(
            alias='eventBusName', title='EventBusName references to a EventBus name. By default the value is "default"'
        ),
    ] = None
    ...
    pub_sub: Annotated[
        Optional[Dict[str, PubSubEventSource]], Field(alias='pubSub', title='PubSub event sources')
    ] = None
    ...
    redis_stream: Annotated[
        Optional[Dict[str, RedisStreamEventSource]], Field(alias='redisStream', title='Redis stream source')
    ] = None
    ...
    storage_grid: Annotated[
        Optional[Dict[str, StorageGridEventSource]], Field(alias='storageGrid', title='StorageGrid event sources')
    ] = None
    stripe: Annotated[Optional[Dict[str, StripeEventSource]], Field(title='Stripe event sources')] = None
    template: Annotated[
        Optional[Template], Field(title='Template is the pod specification for the event source\n+optional')
    ] = None
...
class SensorSpec(ArgoBaseModel):
    ...
    template: Annotated[
        Optional[Template], Field(title='Template is the pod specification for the sensor\n+optional')
    ] = None
    triggers: Annotated[
