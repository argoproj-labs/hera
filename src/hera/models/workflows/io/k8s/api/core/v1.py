...
class AzureDiskVolumeSource(ArgoBaseModel):
    caching_mode: Annotated[
        Optional[str], Field(alias='cachingMode', description='Host Caching mode: None, Read Only, Read Write.')
    ] = None
    disk_name: Annotated[str, Field(alias='diskName', description='The Name of the data disk in the blob storage')]
    disk_uri: Annotated[str, Field(alias='diskURI', description='The URI the data disk in the blob storage')]
    fs_type: Annotated[
        Optional[str],
        Field(
            alias='fsType',
...
class AzureFileVolumeSource(ArgoBaseModel):
    ...
    secret_name: Annotated[
        str,
        Field(alias='secretName', description='the name of secret that contains Azure Storage Account Name and Key'),
    ]
...
class ConfigMapEnvSource(ArgoBaseModel):
    ...
    optional: Annotated[Optional[bool], Field(description='Specify whether the ConfigMap must be defined')] = None
...
class ConfigMapKeySelector(ArgoBaseModel):
    ...
    optional: Annotated[
        Optional[bool], Field(description='Specify whether the ConfigMap or its key must be defined')
    ] = None
...
class ContainerPort(ArgoBaseModel):
    ...
    host_ip: Annotated[
        Optional[str], Field(alias='hostIP', description='What host IP to bind the external port to.')
    ] = None
    host_port: Annotated[
        Optional[int],
        Field(
...
class FCVolumeSource(ArgoBaseModel):
    ...
    target_ww_ns: Annotated[
        Optional[List[str]], Field(alias='targetWWNs', description='Optional: FC target worldwide names (WWNs)')
    ] = None
    wwids: Annotated[
        Optional[List[str]],
        Field(
...
class FlockerVolumeSource(ArgoBaseModel):
    ...
    dataset_uuid: Annotated[
        Optional[str],
        Field(alias='datasetUUID', description='UUID of the dataset. This is unique identifier of a Flocker dataset'),
    ] = None
    ...
    partition: Annotated[
        ...
        Field(
            description=(
                'The partition in the volume that you want to mount. If omitted, the default is to mount by volume'
                ' name. Examples: For volume /dev/sda1, you specify the partition as "1". Similarly, the volume'
                ' partition for /dev/sda is "0" (or you can leave the property empty). More info:'
                ' https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk'
            )
        ),
    ] = None
...
class GRPCAction(ArgoBaseModel):
    port: Annotated[int, Field(description='Port number of the gRPC service. Number must be in the range 1 to 65535.')]
    service: Annotated[
        Optional[str],
        Field(
            description=(
    ...
    directory: Annotated[
        ...
        Field(
            description=(
                ...
                " will be the git repository.  Otherwise, if specified, the volume will contain the git repository in"
    ...
    values: Annotated[
        ...
        Field(
            description=(
                ...
                ' values array must have a single element, which will be interpreted as an integer. This array is'
...
class NodeSelectorTerm(ArgoBaseModel):
    match_expressions: Annotated[
        ...
        Field(alias='matchExpressions', description="A list of node selector requirements by node's labels."),
    ] = None
    match_fields: Annotated[
        Optional[List[NodeSelectorRequirement]],
        Field(alias='matchFields', description="A list of node selector requirements by node's fields."),
    ] = None
...
class ObjectFieldSelector(ArgoBaseModel):
    ...
    field_path: Annotated[
        str, Field(alias='fieldPath', description='Path of the field to select in the specified API version.')
    ]


class ObjectReference(ArgoBaseModel):
    api_version: Annotated[Optional[str], Field(alias='apiVersion', description='API version of the referent.')] = None
    field_path: Annotated[
        Optional[str],
        Field(
            alias='fieldPath',
...
class PersistentVolumeClaimVolumeSource(ArgoBaseModel):
    ...
    read_only: Annotated[
        Optional[bool],
        Field(alias='readOnly', description='Will force the ReadOnly setting in VolumeMounts. Default false.'),
    ] = None
...
class PhotonPersistentDiskVolumeSource(ArgoBaseModel):
    ...
    pd_id: Annotated[str, Field(alias='pdID', description='ID that identifies Photon Controller persistent disk')]
...
class PortworxVolumeSource(ArgoBaseModel):
    ...
    volume_id: Annotated[str, Field(alias='volumeID', description='VolumeID uniquely identifies a Portworx volume')]


class PreferredSchedulingTerm(ArgoBaseModel):
    preference: Annotated[
        NodeSelectorTerm, Field(description='A node selector term, associated with the corresponding weight.')
    ]
    weight: Annotated[
        int,
...
class QuobyteVolumeSource(ArgoBaseModel):
    group: Annotated[Optional[str], Field(description='Group to map volume access to Default is no group')] = None
    read_only: Annotated[
        Optional[bool],
        Field(
            alias='readOnly',
    ...
    user: Annotated[
        Optional[str], Field(description='User to map volume access to Defaults to serivceaccount user')
    ] = None
    volume: Annotated[
        str, Field(description='Volume is a string that references an already created Quobyte volume by name.')
    ]
...
class SELinuxOptions(ArgoBaseModel):
    level: Annotated[
        Optional[str], Field(description='Level is SELinux level label that applies to the container.')
    ] = None
    role: Annotated[
        Optional[str], Field(description='Role is a SELinux role label that applies to the container.')
    ] = None
    type: Annotated[
        Optional[str], Field(description='Type is a SELinux type label that applies to the container.')
    ] = None
    user: Annotated[
        Optional[str], Field(description='User is a SELinux user label that applies to the container.')
    ] = None
...
class ScaleIOVolumeSource(ArgoBaseModel):
    ...
    ssl_enabled: Annotated[
        Optional[bool],
        Field(alias='sslEnabled', description='Flag to enable/disable SSL communication with Gateway, default false'),
    ] = None
    ...
    storage_pool: Annotated[
        Optional[str],
        Field(alias='storagePool', description='The ScaleIO Storage Pool associated with the protection domain.'),
    ] = None
    system: Annotated[str, Field(description='The name of the storage system as configured in ScaleIO.')]
    ...
    type: Annotated[
        ...
        Field(
            description=(
                ...
                ' profile defined in a file on the node should be used. RuntimeDefault - the container runtime default'
                ' profile should be used. Unconfined - no profile should be applied.\n\nPossible enum values:\n -'
                ' `"Localhost"` indicates a profile defined in a file on the node should be used. The file\'s location'
                ' relative to <kubelet-root-dir>/seccomp.\n - `"RuntimeDefault"` represents the default container'
...
class SecretKeySelector(ArgoBaseModel):
    key: Annotated[str, Field(description='The key of the secret to select from.  Must be a valid secret key.')]
    name: Annotated[
        Optional[str],
        Field(
            description=(
    ...
    optional: Annotated[
        Optional[bool], Field(description='Specify whether the Secret or its key must be defined')
    ] = None
    ...
    items: Annotated[
        ...
        Field(
            description=(
                ...
                " the volume as a file whose name is the key and content is the value. If specified, the listed keys"
...
class SecretVolumeSource(ArgoBaseModel):
    default_mode: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' are not affected by this setting. This might be in conflict with other options that affect the file'
    ...
    optional: Annotated[
        Optional[bool], Field(description='Specify whether the Secret or its keys must be defined')
    ] = None
    secret_name: Annotated[
        Optional[str],
        Field(
...
class ServiceAccountTokenProjection(ArgoBaseModel):
    ...
    path: Annotated[
        str, Field(description='Path is the path relative to the mount point of the file to project the token into.')
    ]
    ...
    effect: Annotated[
        ...
        Field(
            description=(
                ...
                ' `"NoExecute"` Evict any already-running pods that do not tolerate the taint. Currently enforced by'
                ' NodeController.\n - `"NoSchedule"` Do not allow new pods to schedule onto the node unless they'
                ' tolerate the taint, but allow all pods submitted to Kubelet without going through the scheduler to'
                ' start, and allow all already-running pods to continue running. Enforced by the scheduler.\n -'
...
class VolumeDevice(ArgoBaseModel):
    ...
    name: Annotated[str, Field(description='name must match the name of a persistentVolumeClaim in the pod')]
...
class VsphereVirtualDiskVolumeSource(ArgoBaseModel):
    ...
    storage_policy_name: Annotated[
        Optional[str],
        Field(alias='storagePolicyName', description='Storage Policy Based Management (SPBM) profile name.'),
    ] = None
    volume_path: Annotated[str, Field(alias='volumePath', description='Path that identifies vSphere volume vmdk')]
...
class ConfigMapProjection(ArgoBaseModel):
    ...
    optional: Annotated[
        Optional[bool], Field(description='Specify whether the ConfigMap or its keys must be defined')
    ] = None
...
class EnvFromSource(ArgoBaseModel):
    config_map_ref: Annotated[
        Optional[ConfigMapEnvSource], Field(alias='configMapRef', description='The ConfigMap to select from')
    ] = None
    prefix: Annotated[
        Optional[str],
    ...
    secret_ref: Annotated[
        Optional[SecretEnvSource], Field(alias='secretRef', description='The Secret to select from')
    ] = None


class EventSeries(ArgoBaseModel):
    count: Annotated[
        Optional[int], Field(description='Number of occurrences in this series up to the last heartbeat time')
    ] = None
    last_observed_time: Annotated[
        Optional[v1.MicroTime], Field(alias='lastObservedTime', description='Time of the last occurrence observed')
    ] = None


class FlexVolumeSource(ArgoBaseModel):
    driver: Annotated[str, Field(description='Driver is the name of the driver to use for this volume.')]
    fs_type: Annotated[
        Optional[str],
        Field(
            alias='fsType',
    ...
    options: Annotated[Optional[Dict[str, str]], Field(description='Optional: Extra command options if any.')] = None
    read_only: Annotated[
        Optional[bool],
        Field(
            alias='readOnly',
    ...
    secret_ref: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' plugin scripts. This may be empty if no secret object is specified. If the secret object contains'
...
class HTTPGetAction(ArgoBaseModel):
    ...
    http_headers: Annotated[
        ...
        Field(alias='httpHeaders', description='Custom headers to set in the request. HTTP allows repeated headers.'),
    ] = None
...
class ISCSIVolumeSource(ArgoBaseModel):
    chap_auth_discovery: Annotated[
        Optional[bool],
        Field(alias='chapAuthDiscovery', description='whether support iSCSI Discovery CHAP authentication'),
    ] = None
    chap_auth_session: Annotated[
        Optional[bool], Field(alias='chapAuthSession', description='whether support iSCSI Session CHAP authentication')
    ] = None
    fs_type: Annotated[
        Optional[str],
        Field(
    ...
    secret_ref: Annotated[
        Optional[LocalObjectReference],
        Field(alias='secretRef', description='CHAP Secret for iSCSI target and initiator authentication'),
    ] = None
...
class NodeSelector(ArgoBaseModel):
    node_selector_terms: Annotated[
        ...
        Field(alias='nodeSelectorTerms', description='Required. A list of node selector terms. The terms are ORed.'),
    ]


class PersistentVolumeClaimCondition(ArgoBaseModel):
    last_probe_time: Annotated[
        Optional[v1.Time], Field(alias='lastProbeTime', description='Last time we probed the condition.')
    ] = None
    last_transition_time: Annotated[
        Optional[v1.Time],
        Field(
            alias='lastTransitionTime', description='Last time the condition transitioned from one status to another.'
        ),
    ] = None
    message: Annotated[
        Optional[str], Field(description='Human-readable message indicating details about last transition.')
    ] = None
    reason: Annotated[
        Optional[str],
        Field(
    ...
    type: Annotated[
        ...
        Field(
            description=(
                ...
                ' file system resize is pending on node\n - `"Resizing"` - a user trigger resize of pvc has been'
                ' started'
            )
        ),
    ]
...
class PersistentVolumeClaimStatus(ArgoBaseModel):
    ...
    allocated_resources: Annotated[
        ...
        Field(
            ...
            description=(
                'The storage resource within AllocatedResources tracks the capacity allocated to a PVC. It may be'
                ' larger than the actual capacity when a volume expansion operation is requested. For storage quota,'
                ' the larger value from allocatedResources and PVC.spec.resources is used. If allocatedResources is'
                ' not set, PVC.spec.resources alone is used for quota calculation. If a volume expansion capacity'
                ' request is lowered, allocatedResources is only lowered if there are no expansion operations in'
                ' progress and if the actual volume capacity is equal or lower than the requested capacity. This is an'
    ...
    phase: Annotated[
        ...
        Field(
            description=(
                ...
                ' used for PersistentVolumeClaims that are bound\n - `"Lost"` used for PersistentVolumeClaims that'
                ' lost their underlying PersistentVolume. The claim was bound to a PersistentVolume and this volume'
    ...
    resize_status: Annotated[
        ...
        Field(
            alias='resizeStatus',
            description=(
                'ResizeStatus stores status of resize operation. ResizeStatus is not set by default but when expansion'
                ' is complete resizeStatus is set to empty string by resize controller or kubelet. This is an alpha'
    ...
    fs_group: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                " and permissions of any volume. Note that this field cannot be set when spec.os.name is windows."
            ),
        ),
    ] = None
...
class ResourceFieldSelector(ArgoBaseModel):
    container_name: Annotated[
        Optional[str],
        Field(alias='containerName', description='Container name: required for volumes, optional for env vars'),
    ] = None
    divisor: Annotated[
        Optional[resource.Quantity],
...
class SecurityContext(ArgoBaseModel):
    ...
    read_only_root_filesystem: Annotated[
        ...
        Field(
            ...
            description=(
                'Whether this container has a read-only root filesystem. Default is false. Note that this field cannot'
                ' be set when spec.os.name is windows.'
            ),
        ),
    ] = None
...
class ServicePort(ArgoBaseModel):
    ...
    target_port: Annotated[
        ...
        Field(
            alias='targetPort',
            description=(
                "Number or name of the port to access on the pods targeted by the service. Number must be in the range"
                " 1 to 65535. Name must be an IANA_SVC_NAME. If this is a string, it will be looked up as a named port"
                " in the target Pod's container ports. If this is not specified, the value of the 'port' field is used"
                " (an identity map). This field is ignored for services with clusterIP=None, and should be omitted or"
...
class TCPSocketAction(ArgoBaseModel):
    host: Annotated[
        Optional[str], Field(description='Optional: Host name to connect to, defaults to the pod IP.')
    ] = None
    port: Annotated[
        intstr.IntOrString,
        Field(
...
class DownwardAPIVolumeSource(ArgoBaseModel):
    ...
    items: Annotated[
        Optional[List[DownwardAPIVolumeFile]], Field(description='Items is a list of downward API volume file')
    ] = None
...
class EnvVarSource(ArgoBaseModel):
    ...
    secret_key_ref: Annotated[
        ...
        Field(alias='secretKeyRef', description="Selects a key of a secret in the pod's namespace"),
    ] = None


class Event(ArgoBaseModel):
    action: Annotated[
        Optional[str], Field(description='What action was taken/failed regarding to the Regarding object.')
    ] = None
    api_version: Annotated[
        Optional[str],
        Field(
    ...
    event_time: Annotated[
        Optional[v1.MicroTime], Field(alias='eventTime', description='Time when this Event was first observed.')
    ] = None
    ...
    involved_object: Annotated[
        ObjectReference, Field(alias='involvedObject', description='The object that this event is about.')
    ]
    kind: Annotated[
        Optional[str],
        Field(
    ...
    message: Annotated[
        Optional[str], Field(description='A human-readable description of the status of this operation.')
    ] = None
    metadata: Annotated[
        v1.ObjectMeta,
        Field(
    ...
    related: Annotated[
        Optional[ObjectReference], Field(description='Optional secondary object for more complex actions.')
    ] = None
    ...
    reporting_instance: Annotated[
        Optional[str],
        Field(alias='reportingInstance', description='ID of the controller instance, e.g. `kubelet-xyzf`.'),
    ] = None
    series: Annotated[
...
class LifecycleHandler(ArgoBaseModel):
    ...
    http_get: Annotated[
        Optional[HTTPGetAction], Field(alias='httpGet', description='HTTPGet specifies the http request to perform.')
    ] = None
...
class PersistentVolumeClaimSpec(ArgoBaseModel):
    ...
    data_source_ref: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' This may be any local object from a non-empty API group (non core object) or a PersistentVolumeClaim'
                ' object. When this field is specified, volume binding will only succeed if the type of the specified'
                ' object matches some installed volume populator or dynamic provisioner. This field will replace the'
                ' functionality of the DataSource field and as such if both fields are non-empty, they must have the'
                ' same value. For backwards compatibility, both fields (DataSource and DataSourceRef) will be set to'
                ' the same value automatically if one of them is empty and the other is non-empty. There are two'
    ...
    selector: Annotated[
        Optional[v1.LabelSelector], Field(description='A label query over volumes to consider for binding.')
    ] = None
...
class PersistentVolumeClaimTemplate(ArgoBaseModel):
    metadata: Annotated[
        ...
        Field(
            description=(
                'May contain labels and annotations that will be copied into the PVC when creating it. No other fields'
...
class PodAffinityTerm(ArgoBaseModel):
    label_selector: Annotated[
        ...
        Field(alias='labelSelector', description='A label query over a set of resources, in this case pods.'),
    ] = None
    namespace_selector: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' namespaces. This field is beta-level and is only honored when PodAffinityNamespaceSelector feature'
                ' is enabled.'
            ),
        ),
    ] = None
    ...
    topology_key: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' value of the label with key topologyKey matches that of any node on which any of the selected pods'
...
class Probe(ArgoBaseModel):
    ...
    success_threshold: Annotated[
        ...
        Field(
            ...
            description=(
                'Minimum consecutive successes for the probe to be considered successful after having failed. Defaults'
    ...
    tcp_socket: Annotated[
        Optional[TCPSocketAction],
        Field(alias='tcpSocket', description='TCPSocket specifies an action involving a TCP port.'),
    ] = None
...
class DownwardAPIProjection(ArgoBaseModel):
    items: Annotated[
        Optional[List[DownwardAPIVolumeFile]], Field(description='Items is a list of DownwardAPIVolume file')
    ] = None


class EnvVar(ArgoBaseModel):
    name: Annotated[str, Field(description='Name of the environment variable. Must be a C_IDENTIFIER.')]
    value: Annotated[
        Optional[str],
        Field(
            description=(
    ...
    volume_claim_template: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' that is not owned by the pod will *not* be used for the pod to avoid using an unrelated volume by'
                ' mistake. Starting the pod is then blocked until the unrelated PVC is removed. If such a pre-created'
                ' PVC is meant to be used by the pod, the PVC has to updated with an owner reference to the pod once'
                ' the pod exists. Normally this should not be necessary, but it may be useful when manually'
    ...
    required_during_scheduling_ignored_during_execution: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' eventually evict the pod from its node. When there are multiple elements, the lists of nodes'
...
class VolumeProjection(ArgoBaseModel):
    config_map: Annotated[
        ...
        Field(alias='configMap', description='information about the configMap data to project'),
    ] = None
    downward_api: Annotated[
        Optional[DownwardAPIProjection],
        Field(alias='downwardAPI', description='information about the downwardAPI data to project'),
    ] = None
    secret: Annotated[
        Optional[SecretProjection], Field(description='information about the secret data to project')
    ] = None
    service_account_token: Annotated[
        Optional[ServiceAccountTokenProjection],
        Field(alias='serviceAccountToken', description='information about the serviceAccountToken data to project'),
    ] = None
...
class Affinity(ArgoBaseModel):
    node_affinity: Annotated[
        ...
        Field(alias='nodeAffinity', description='Describes node affinity scheduling rules for the pod.'),
    ] = None
    ...
    image_pull_policy: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' `"Always"` means that kubelet always attempts to pull the latest image. Container will fail If the'
                ' pull fails.\n - `"IfNotPresent"` means that kubelet pulls if the image isn\'t present on disk.'
                ' Container will fail if the image isn\'t present and the pull fails.\n - `"Never"` means that kubelet'
                ' never pulls an image, but only uses a local image. Container will fail if the image isn\'t present'
            ),
        ),
    ] = None
    lifecycle: Annotated[
    ...
    termination_message_policy: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' status message when the container exits with an error and the terminationMessagePath has no'
...
class ProjectedVolumeSource(ArgoBaseModel):
    ...
    sources: Annotated[Optional[List[VolumeProjection]], Field(description='list of volume projections')] = None
...
class Volume(ArgoBaseModel):
    ...
    config_map: Annotated[
        ...
        Field(alias='configMap', description='ConfigMap represents a configMap that should populate this volume'),
    ] = None
    csi: Annotated[
    ...
    ephemeral: Annotated[
        ...
        Field(
            description=(
                ...
                " volumes like restoring from snapshot or capacity\n   tracking are needed,\nc) the storage driver is"
                " specified through a storage class, and d) the storage driver supports dynamic volume provisioning"
                " through\n   a PersistentVolumeClaim (see EphemeralVolumeSource for more\n   information on the"
                " connection between this volume type\n   and PersistentVolumeClaim).\n\nUse PersistentVolumeClaim or"
                " one of the vendor-specific APIs for volumes that persist for longer than the lifecycle of an"
                ...
                " types of ephemeral volumes and persistent volumes at the same time."
            )
        ),
    ] = None
    fc: Annotated[
