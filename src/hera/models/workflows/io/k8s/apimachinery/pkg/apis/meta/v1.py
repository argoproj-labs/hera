...
class ObjectMeta(BaseModel):
    ...
    managed_fields: Optional[List[ManagedFieldsEntry]] = Field(
        ...
        description=(
            ...
            " is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field."
            " A workflow can be the user's name, a controller's name, or the name of a specific apply path like"
