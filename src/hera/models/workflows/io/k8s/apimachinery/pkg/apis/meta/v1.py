...
class CreateOptions(ArgoBaseModel):
    ...
    field_manager: Annotated[
        ...
        Field(
            alias='fieldManager',
            title=(
                'fieldManager is a name associated with the actor or entity\nthat is making these changes. The value'
    ...
    field_validation: Annotated[
        ...
        Field(
            ...
            title=(
                'fieldValidation instructs the server on how to handle\nobjects in the request (POST/PUT/PATCH)'
                ' containing unknown\nor duplicate fields, provided that the `ServerSideFieldValidation`\nfeature gate'
                ' is also enabled. Valid values are:\n- Ignore: This will ignore any unknown fields that are'
                ' silently\ndropped from the object, and will ignore all but the last duplicate\nfield that the'
                ' decoder encounters. This is the default behavior\nprior to v1.23 and is the default behavior when'
                ' the\n`ServerSideFieldValidation` feature gate is disabled.\n- Warn: This will send a warning via the'
                ' standard warning response\nheader for each unknown field that is dropped from the object, and\nfor'
                ' each duplicate field that is encountered. The request will\nstill succeed if there are no other'
                ' errors, and will only persist\nthe last of any duplicate fields. This is the default when'
                ' the\n`ServerSideFieldValidation` feature gate is enabled.\n- Strict: This will fail the request with'
                ' a BadRequest error if\nany unknown fields would be dropped from the object, or if any\nduplicate'
                ' fields are present. The error returned from the server\nwill contain all unknown and duplicate'
                ' fields encountered.\n+optional'
            ),
        ),
    ] = None
    ...
    self_link: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' Kubernetes will stop propagating this field in 1.20 release and the field is planned to be removed'
                ' in 1.21 release.'
            ),
        ),
    ] = None
...
class MicroTime(ArgoBaseModel):
    __root__: Annotated[datetime, Field(description='MicroTime is version of Time with microsecond level precision.')]
...
class OwnerReference(ArgoBaseModel):
    ...
    controller: Annotated[
        Optional[bool], Field(description='If true, this reference points to the managing controller.')
    ] = None
    kind: Annotated[
        str,
        Field(
    ...
    uid: Annotated[
        str, Field(description='UID of the referent. More info: http://kubernetes.io/docs/user-guide/identifiers#uids')
    ]
...
class StatusCause(ArgoBaseModel):
    field: Annotated[
        ...
        Field(
            description=(
                'The field of the resource that has caused this error, as named by its JSON serialization. May include'
                ' dot and postfix notation for nested attributes. Arrays are zero-indexed.  Fields may appear more'
...
class ManagedFieldsEntry(ArgoBaseModel):
    ...
    manager: Annotated[
        Optional[str], Field(description='Manager is an identifier of the workflow managing these fields.')
    ] = None
    operation: Annotated[
        Optional[str],
        Field(
...
class ObjectMeta(ArgoBaseModel):
    ...
    creation_timestamp: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' guaranteed to be set in happens-before order across separate operations. Clients may not set this'
                ' value. It is represented in RFC3339 form and is in UTC.\n\nPopulated by the system. Read-only. Null'
                ' for lists. More info:'
    ...
    deletion_timestamp: Annotated[
        ...
        Field(
            ...
            description=(
                'DeletionTimestamp is RFC 3339 date and time at which this resource will be deleted. This field is set'
                ' by the server when a graceful deletion is requested by the user, and is not directly settable by a'
                ' client. The resource is expected to be deleted (no longer visible from resource lists, and not'
    ...
    generate_name: Annotated[
        ...
        Field(
            ...
            description=(
                ...
                ' generated name exists, the server will NOT return a 409 - instead, it will either return 201 Created'
                ' or 500 with Reason ServerTimeout indicating a unique name could not be found in the time allotted,'
                ' and the client should retry (optionally after the time indicated in the Retry-After'
    ...
    namespace: Annotated[
        ...
        Field(
            description=(
                ...
                ' required to be scoped to a namespace - the value of this field for those objects will be'
    ...
    uid: Annotated[
        ...
        Field(
            description=(
                ...
                ' the system. Read-only. More info: http://kubernetes.io/docs/user-guide/identifiers#uids'
            )
        ),
    ] = None
