...
class TestResources:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (0.5, "500m", None, None, None, None),
            ("500m", 0.5, None, None, None, None),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (1, "500m", None, None, None, None, "request must be smaller or equal to limit"),
            ("1000m", 0.5, None, None, None, None, "request must be smaller or equal to limit"),
